        ...
        headers: [
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.googletagmanager.com https://*.google-analytics.com https://*.googleapis.com https://*.gstatic.com https://*.hubspot.com https://*.hsforms.com https://*.hs-scripts.com https://*.hs-analytics.net https://*.hscollectedforms.net https://*.usemessages.com https://*.hs-banner.com https://js.hsadspixel.net https://js.hs-analytics.net https://js.usemessages.com https://js.hscollectedforms.net https://*.cloudflareinsights.com https://static.cloudflareinsights.com https://scripts.simpleanalyticscdn.com https://www.clarity.ms https://scripts.clarity.ms https://app.partnero.com https://assets.partnero.com https://widget.intercom.io https://js.intercomcdn.com",
              "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://js.intercomcdn.com",
              "img-src 'self' data: blob: https://*.datocms-assets.com https://*.googleusercontent.com https://*.google-analytics.com https://*.googletagmanager.com https://deifkwefumgah.cloudfront.net https://*.hubspot.com https://*.hsforms.com https://*.hs-analytics.net https://*.simpleanalyticscdn.com https://*.intercomcdn.com https://*.intercom.io",
              "font-src 'self' https://fonts.gstatic.com https://js.intercomcdn.com",
              "connect-src 'self' https://*.google-analytics.com https://*.analytics.google.com https://*.googletagmanager.com https://*.hubspot.com https://*.hsforms.com https://*.hs-analytics.net https://*.hscollectedforms.net https://*.datocms-assets.com https://*.datocms.com https://*.cloudflareinsights.com https://*.simpleanalyticscdn.com https://*.clarity.ms https://app.partnero.com https://assets.partnero.com https://api-iam.intercom.io https://*.intercom.io https://*.intercomcdn.com wss://*.intercom.io",
              "frame-src 'self' https://*.hubspot.com https://*.hsforms.com https://*.youtube.com https://*.youtube-nocookie.com https://*.intercom.io https://*.vercel.app",
              "media-src 'self'",
              "object-src 'none'",
              "base-uri 'self'",
