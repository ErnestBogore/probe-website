...
export const toolsEs: Record<string, ToolConfig> = {
  ...
  'generador-de-parrafos': {
    ...
    metaDescription: 'Genera párrafos bien estructurados en segundos con nuestro generador de párrafos con IA gratuito. Perfecto para blogs, ensayos, correos y más. Sin registro.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'reescritor-de-parrafos': {
    ...
    metaDescription: 'Reescribe párrafos con nuestra herramienta gratuita de IA. Mejora la claridad, cambia el tono o crea variaciones únicas mientras preservas el significado original.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'herramienta-de-parafraseo': {
    ...
    metaDescription: 'Parafrasea cualquier texto instantáneamente con nuestra herramienta gratuita de IA. Reformula oraciones y párrafos mientras mantienes el significado original.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'reescritor-de-oraciones': {
    ...
    metaDescription: 'Reescribe oraciones para mayor claridad, impacto o mejor tono. Obtén múltiples variaciones con explicaciones de qué hace cada una más fuerte. Gratis, sin registro.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'resumidor': {
    ...
    metaDescription: 'Condensa artículos largos, documentos y textos en resúmenes claros y concisos. Nuestro resumidor con IA extrae los puntos clave en segundos. Pruébalo ahora.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'generador-de-esquemas': {
    ...
    metaDescription: 'Genera esquemas estructurados para publicaciones de blog, ensayos y artículos en segundos. Nuestro generador de esquemas con IA te ayuda a organizar ideas y escribir más rápido.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'generador-de-introducciones': {
    ...
    metaDescription: 'Crea introducciones cautivadoras que enganchen a los lectores desde la primera oración. Nuestra herramienta gratuita de IA genera aperturas atractivas para cualquier contenido.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'generador-de-conclusiones': {
    ...
    metaDescription: 'Genera conclusiones convincentes para cualquier artículo, ensayo o publicación de blog. Nuestra herramienta gratuita de IA crea finales satisfactorios con conclusiones claras y CTAs.',
    inputLabel: 'Tema del artículo y puntos clave...',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'generador-lorem-ipsum': {
    ...
    metaDescription: 'Genera texto de relleno lorem ipsum para diseños, maquetas y layouts. Elige entre alternativas tradicionales o modernas. Listo para copiar y pegar.',
...
IMPORTANT: Generate all output in Spanish (except for traditional Lorem Ipsum which remains in Latin).`,
  ...
  'extensor-de-texto': {
    ...
    metaDescription: 'Expande oraciones cortas o párrafos en contenido más detallado y completo. Nuestra herramienta gratuita de IA agrega profundidad sin relleno.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'generador-de-titulos-para-blog': {
    ...
    metaDescription: 'Genera títulos de blog atractivos que impulsan clics y posicionan en búsquedas. Nuestra IA crea titulares optimizados para SEO usando disparadores psicológicos probados.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'generador-de-metadescripciones': {
    ...
    metaDescription: 'Crea metadescripciones atractivas que mejoran las tasas de clics. Nuestra herramienta gratuita de IA genera descripciones optimizadas para cualquier página web en segundos.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'generador-de-titulos-seo': {
    ...
    metaDescription: 'Genera etiquetas de título optimizadas para búsquedas que clasifican más alto y obtienen más clics. Nuestra IA crea títulos perfectamente dimensionados con palabras clave en las posiciones correctas.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'generador-de-textos-alternativos': {
    ...
    metaDescription: 'Genera texto alternativo descriptivo que mejora la accesibilidad y el SEO. Sube cualquier imagen y obtén descripciones amigables para lectores de pantalla optimizadas para búsqueda.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'generador-de-ideas-de-contenido': {
    ...
    metaDescription: 'Genera ideas de contenido creativas para blogs, YouTube, redes sociales, podcasts y newsletters. Nuestra IA crea conceptos optimizados por plataforma con ángulos únicos.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'creador-de-guiones-de-videos': {
    ...
    metaDescription: 'Genera guiones de video atractivos para YouTube, TikTok, Reels y más. Nuestra IA crea guiones optimizados para retención con ganchos, señales visuales y CTAs.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'generador-de-acronimos': {
    ...
    metaDescription: 'Genera acrónimos inteligentes y significativos para proyectos, productos y organizaciones. Obtén múltiples opciones con significados expandidos. Gratuito e instantáneo.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'detector-de-ia': {
    ...
    metaDescription: 'Detecta contenido generado por IA instantáneamente con nuestra herramienta gratuita. Obtén análisis detallado y aprende qué hace que tu texto suene como IA. Sin registro requerido.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'humanizador-de-texto': {
    ...
    metaDescription: 'Transforma texto generado por IA en escritura natural y humana. Nuestro humanizador gratuito elimina patrones robóticos mientras mantiene tu significado original intacto.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'creador-de-eslogan': {
    ...
    metaDescription: 'Crea eslóganes pegadizos y memorables que capturan la esencia de tu marca. Nuestra IA genera taglines que permanecen en la mente de los clientes.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'generador-de-texto-para-anuncios': {
    ...
    metaDescription: 'Genera copy para Google Ads de alta conversión que impulsa clics y conversiones. Nuestra IA crea titulares y descripciones optimizados para el rendimiento.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'generador-de-descripciones-de-productos': {
    ...
    metaDescription: 'Genera descripciones de productos convincentes que venden. Nuestra IA crea copy enfocado en beneficios para e-commerce, marketplaces y catálogos.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'generador-de-paginas-de-aterrizaje': {
    ...
    metaDescription: 'Genera copy completo para páginas de aterrizaje que convierte. Nuestra IA crea titulares, características, testimonios, FAQs y CTAs para tu oferta.',
    inputLabel: 'Describe tu producto/servicio y oferta...',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'generador-de-ganchos': {
    ...
    metaDescription: 'Crea ganchos que capturan atención para tu contenido al instante. Nuestra IA genera líneas de apertura convincentes que capturan lectores y aumentan el engagement.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'generador-de-cartas-de-renuncia': {
    ...
    metaDescription: 'Escribe una carta de renuncia profesional en minutos. Nuestra IA crea cartas pulidas y apropiadas que preservan relaciones y protegen tu reputación.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'generador-de-biografias-para-redes': {
    ...
    metaDescription: 'Genera la bio perfecta para tus perfiles de redes sociales al instante. Nuestra IA crea bios atractivas y profesionales que capturan tu marca personal y atraen seguidores.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'generador-de-biografias-para-instagram': {
    ...
    metaDescription: 'Crea la bio perfecta de Instagram en segundos. Nuestra IA genera bios atractivas y llenas de personalidad que atraen seguidores y muestran tu marca personal.',
    inputLabel: 'Descríbete a ti o tu marca...',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'generador-de-frases-para-instagram': {
    ...
    metaDescription: 'Crea captions para Instagram que detienen el scroll al instante. Nuestra IA genera captions atractivos para Reels, carruseles y publicaciones del feed.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'generador-de-hashtags-para-redes': {
    ...
    metaDescription: 'Genera hashtags efectivos que aumentan tu alcance y engagement. Nuestra IA crea conjuntos estratégicos de hashtags para Instagram, TikTok, Twitter y más.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'generador-de-hashtags-para-instagram': {
    ...
    metaDescription: 'Genera los hashtags perfectos de Instagram para aumentar tu alcance y engagement. Nuestra IA crea conjuntos estratégicos de hashtags adaptados a tu contenido.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'generador-de-nombres-de-usuario-para-redes': {
    ...
    metaDescription: 'Genera nombres de usuario únicos y memorables para tus perfiles de redes sociales. Nuestra IA crea ideas que funcionan en múltiples plataformas.',
    inputLabel: 'Descríbete a ti o tu marca...',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'generador-de-hashtags-para-tiktok': {
    ...
    metaDescription: 'Genera hashtags de TikTok en tendencia que aumentan tu visibilidad. Nuestra IA crea combinaciones estratégicas para llegar a la página Para Ti.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'generador-de-descripciones-para-canales-de-youtube': {
    ...
    metaDescription: 'Crea una descripción de canal de YouTube atractiva que atraiga suscriptores. Nuestra IA genera descripciones optimizadas para SEO que muestran tu contenido y hacen crecer tu audiencia.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'generador-de-nombres-para-youtube': {
    ...
    metaDescription: 'Genera nombres creativos para canales de YouTube que destaquen. Nuestra IA crea nombres memorables y con potencial de marca que atraen suscriptores y reflejan tu nicho de contenido.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'generador-de-descripciones-para-videos-de-youtube': {
    ...
    metaDescription: 'Genera descripciones de YouTube optimizadas para SEO que aumentan las vistas. Nuestra IA crea descripciones atractivas con ganchos, marcas de tiempo y palabras clave que ayudan a posicionar mejor los videos.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'parafraseador-de-textos': {
    ...
    metaDescription: 'Reformula y parafrasea texto instantáneamente con nuestra herramienta de IA. Transforma oraciones y párrafos para mejorar claridad, cambiar tono o crear contenido único.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'corrector-gramatical': {
    ...
    metaDescription: 'Revisa tu gramática, ortografía y puntuación gratis. Obtén correcciones instantáneas con explicaciones claras para mejorar tus habilidades de escritura.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'detector-de-plagio': {
    ...
    metaDescription: 'Analiza tu contenido para originalidad e identifica pasajes que pueden necesitar citas o reescritura. Obtén retroalimentación accionable para mejorar tu escritura.',
    inputLabel: 'Texto a revisar...',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'generador-de-ideas-para-blog': {
    ...
    metaDescription: '¿Luchas con ideas de contenido? Genera ideas de publicaciones de blog únicas y optimizadas para SEO en segundos. Nuestra IA entrega temas listos para escribir.',
    inputLabel: 'Tema o nicho...',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'traductor-de-emojis': {
    ...
    metaDescription: 'Traduce texto a emojis expresivos o decodifica mensajes de emojis. Perfecto para redes sociales, mensajería y comunicación divertida. Gratis para usar.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'generador-de-nombres-de-marca': {
    ...
    metaDescription: 'Genera nombres de marca únicos y memorables al instante. Nuestra IA crea nombres distintivos con significado estratégico para la identidad de tu negocio.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'generador-de-nombres-comerciales': {
    ...
    metaDescription: 'Genera nombres de negocio creativos que funcionan en el mundo real. Nuestra IA crea nombres profesionales y memorables para cualquier industria.',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'generador-de-nombres-de-productos': {
    ...
    metaDescription: 'Genera nombres de productos creativos que venden. Nuestra IA crea nombres memorables y listos para el mercado que destacan en estantes y en la mente de los clientes.',
    inputLabel: 'Describe tu producto...',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'generador-de-textos-para-sitios-web': {
    ...
    metaDescription: 'Genera contenido profesional para sitios web en minutos. Nuestra IA crea textos para páginas de inicio, páginas de nosotros, páginas de servicios y más.',
    inputLabel: 'Describe tu negocio...',
...
IMPORTANT: Generate all output in Spanish.`,
  ...
  'generador-de-frases-para-redes-sociales': {
    ...
    metaDescription: 'Genera frases atractivas para redes sociales que impulsan likes, comentarios y compartidos. Nuestra IA crea textos convincentes para Instagram, Facebook, Twitter y más.',
