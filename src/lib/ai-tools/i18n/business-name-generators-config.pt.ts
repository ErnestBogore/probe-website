...
// ==================== PORTUGUESE (pt) TRANSLATION - BATCH 1 (1-5) ====================
  ...
  'aesthetic': {
    ...
    metaDescription: 'Descubra um nome cativante para o seu negócio de estética com nosso gerador por IA. Crie nomes elegantes e sofisticados para spas médicos, clínicas e consultórios de beleza. Gratuito e fácil de usar!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'agency': {
    ...
    metaDescription: 'Lance sua agência com um nome brilhante do nosso gerador gratuito por IA. Crie nomes profissionais e confiáveis para agências de marketing, criativas, digitais e de consultoria. Simples e personalizado!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'app': {
    ...
    metaDescription: 'Descubra o nome perfeito para seu aplicativo com nosso gerador gratuito por IA. Crie nomes cativantes e memoráveis para apps móveis, web apps e startups de software. Rápido, fácil e personalizado!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'babysitting': {
    ...
    metaDescription: 'Crie o nome perfeito para seu serviço de babá com nosso gerador gratuito por IA. Gere nomes confiáveis e carinhosos que transmitem segurança e cuidado. Ideal para babás, creches e cuidadores!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'beauty': {
    ...
    metaDescription: 'Descubra o nome perfeito para seu negócio de beleza com nosso gerador gratuito por IA. Crie nomes glamourosos e atraentes para salões, spas e marcas de cosméticos. Destaque-se no mercado de beleza!',
...
// ==================== PORTUGUESE (pt) TRANSLATION - BATCH 2 (6-10) ====================
  ...
  'boutique': {
    ...
    metaDescription: 'Crie o nome perfeito para sua boutique com nosso gerador gratuito por IA. Gere nomes elegantes e sofisticados que transmitem exclusividade, estilo e curadoria. Ideal para lojas de moda, acessórios e varejo de luxo!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'cafe': {
    ...
    metaDescription: 'Encontre o nome perfeito para sua cafeteria com nosso gerador gratuito por IA. Crie nomes acolhedores e memoráveis que atraem amantes de café e criam atmosfera convidativa. Ideal para coffee shops, cafés especiais e bistrôs!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'cake': {
    ...
    metaDescription: 'Crie o nome perfeito para sua confeitaria com nosso gerador gratuito por IA. Gere nomes doces e irresistíveis que comunicam arte, sabor e celebração. Ideal para cake designers, confeitarias artesanais e bolos decorados!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'candle': {
    ...
    metaDescription: 'Ilumine sua marca de velas com o nome perfeito do nosso gerador gratuito por IA. Crie nomes aromáticos e evocativos que transmitem aconchego, bem-estar e artesanato. Ideal para velas artesanais, aromáticas e decorativas!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'candy': {
    ...
    metaDescription: 'Adoce seu negócio com o nome perfeito do nosso gerador gratuito por IA. Crie nomes doces e irresistíveis para lojas de doces, confeitarias e negócios de guloseimas. Divertido, memorável e gratuito!',
...
// ==================== PORTUGUESE (pt) TRANSLATION - BATCH 3 (11-15) ====================
  ...
  'cookie': {
    ...
    metaDescription: 'Crie o nome perfeito para seu negócio de biscoitos com nosso gerador gratuito por IA. Gere nomes doces e memoráveis que comunicam sabor, qualidade e tradição. Ideal para cookies, biscoitos artesanais e confeitarias!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'cosmetic': {
    ...
    metaDescription: 'Lance sua marca de cosméticos com o nome perfeito do nosso gerador gratuito por IA. Crie nomes glamourosos e sofisticados que comunicam beleza, qualidade e inovação. Ideal para maquiagem, skincare e beleza!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'crochet': {
    ...
    metaDescription: 'Crie o nome perfeito para seu negócio de crochê com nosso gerador gratuito por IA. Gere nomes artesanais e encantadores que comunicam craft, carinho e tradição. Ideal para crochê, tricô e artesanato têxtil!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'dessert': {
    ...
    metaDescription: 'Adoce seu negócio com o nome perfeito do nosso gerador gratuito por IA. Crie nomes irresistíveis para confeitarias, patisseries e negócios de sobremesas que comunicam sabor e sofisticação!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'electronics': {
    ...
    metaDescription: 'Lance sua loja de eletrônicos com o nome perfeito do nosso gerador gratuito por IA. Crie nomes modernos e confiáveis que comunicam inovação, qualidade e expertise técnica!',
...
// ==================== PORTUGUESE (pt) TRANSLATION - BATCH 4 (16-20) ====================
  ...
  'event': {
    ...
    metaDescription: 'Lance sua empresa de eventos com o nome perfeito do nosso gerador gratuito por IA. Crie nomes memoráveis que comunicam celebração, profissionalismo e criatividade. Ideal para produtoras, organizadores e cerimonialistas!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'fitness': {
    ...
    metaDescription: 'Lance seu negócio fitness com o nome perfeito do nosso gerador gratuito por IA. Crie nomes energéticos e motivadores que inspiram transformação, saúde e performance. Ideal para academias, personal trainers e studios!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'flower-shop': {
    ...
    metaDescription: 'Floresça no mercado com o nome perfeito do nosso gerador gratuito por IA. Crie nomes encantadores e elegantes para floriculturas, studios florais e designers de arranjos. Romântico, memorável e gratuito!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'food': {
    ...
    metaDescription: 'Crie o nome perfeito para seu negócio de alimentação com nosso gerador gratuito por IA. Gere nomes apetitosos e memoráveis para restaurantes, lanchonetes e delivery. Atraia clientes com um nome irresistível!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'funny': {
    ...
    metaDescription: 'Destaque seu negócio com um nome engraçado e memorável do nosso gerador gratuito por IA. Crie nomes divertidos que viralizam, atraem atenção e ficam na memória. Perfeito para marcas com personalidade!',
...
'game': {
    ...
    metaDescription: 'Gere nomes criativos e impactantes para sua empresa de jogos com nosso gerador gratuito por IA. Crie identidades de marca únicas para estúdios de desenvolvimento, empresas de e-sports, lojas de games e startups do setor de entretenimento digital.',
...
Generate names that feel authentic to gaming culture while maintaining professionalism for business contexts.`,
  ...
  'hair': {
    ...
    metaDescription: 'Gere nomes criativos e sofisticados para seu negócio de cabelo com nosso gerador gratuito por IA. Crie identidades de marca únicas para salões de beleza, barbearias, clínicas capilares, studios de coloração e linhas de produtos.',
...
Generate names that feel professional and appealing to clients while standing out in a competitive market.`,
  ...
  'health': {
    ...
    metaDescription: 'Gere nomes profissionais e memoráveis para sua empresa de saúde com nosso gerador gratuito por IA. Crie identidades de marca confiáveis para clínicas, consultórios, laboratórios, healthtechs e serviços de bem-estar.',
...
Generate names that inspire confidence while remaining accessible and memorable.`,
  ...
  'it': {
    ...
    metaDescription: 'Gere nomes criativos e profissionais para sua empresa de TI com nosso gerador gratuito por IA. Crie identidades de marca únicas para software houses, consultorias, startups de tecnologia, MSPs e empresas de desenvolvimento.',
...
Generate names that balance technical credibility with approachability and memorability.`,
  ...
  'marketing': {
    ...
    metaDescription: 'Gere nomes criativos e impactantes para sua agência de marketing com nosso gerador gratuito por IA. Crie identidades de marca únicas para agências digitais, consultorias de branding, empresas de publicidade e estúdios criativos.',
...
'clothing-store': {
    ...
    metaDescription: 'Crie o nome perfeito para sua loja de roupas com nosso gerador gratuito por IA. Desenvolva nomes estilosos e memoráveis para boutiques, lojas de moda e varejo de vestuário. Rápido, fácil e personalizado!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'craft-store': {
    ...
    metaDescription: 'Encontre o nome ideal para sua loja de artesanato com nosso gerador gratuito por IA. Crie nomes criativos e acolhedores para lojas de materiais de artesanato, armarinhos e papelarias criativas. Inspire sua marca!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'digital-marketing': {
    ...
    metaDescription: 'Crie um nome marcante para sua agência de marketing digital com nosso gerador gratuito por IA. Desenvolva nomes modernos e impactantes para agências de social media, SEO, performance e marketing de conteúdo!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'fashion-store': {
    ...
    metaDescription: 'Lance sua loja de moda com um nome perfeito do nosso gerador gratuito por IA. Crie nomes elegantes e sofisticados para boutiques, marcas de vestuário e lojas fashion. Destaque-se no mundo da moda!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'food-truck': {
    ...
    metaDescription: 'Encontre o nome perfeito para seu food truck com nosso gerador gratuito por IA. Crie nomes criativos e chamativos para trailers de comida, food bikes e negócios de street food. Destaque-se nas ruas!',
...
'furniture-store': {
    ...
    metaDescription: 'Crie o nome perfeito para sua loja de móveis com nosso gerador gratuito por IA. Desenvolva nomes elegantes e memoráveis para lojas de móveis, decoração e home design. Inspire ambientes!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'graphic-design': {
    ...
    metaDescription: 'Crie um nome marcante para seu estúdio de design gráfico com nosso gerador gratuito por IA. Desenvolva nomes criativos e profissionais para agências de design, estúdios criativos e designers freelancer!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'ice-cream': {
    ...
    metaDescription: 'Encontre o nome perfeito para sua sorveteria com nosso gerador gratuito por IA. Crie nomes doces e irresistíveis para gelaterias, açaiterias e negócios de sobremesas geladas. Adoce sua marca!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'interior-design': {
    ...
    metaDescription: 'Lance seu escritório de design de interiores com um nome perfeito do nosso gerador gratuito por IA. Crie nomes sofisticados e inspiradores para designers, decoradores e arquitetos de interiores!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'jewelry-store': {
    ...
    metaDescription: 'Crie o nome perfeito para sua joalheria com nosso gerador gratuito por IA. Desenvolva nomes elegantes e luxuosos para joalherias, bijuterias finas e marcas de acessórios preciosos. Brilhe no mercado!',
...
'lip-gloss': {
    ...
    metaDescription: 'Crie o nome perfeito para sua marca de lip gloss com nosso gerador gratuito por IA. Desenvolva nomes glamourosos e irresistíveis para lip glosses, batons e cosméticos labiais. Brilhe no mercado de beleza!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'music': {
    ...
    metaDescription: 'Encontre o nome perfeito para seu negócio de música com nosso gerador gratuito por IA. Crie nomes criativos e memoráveis para estúdios, escolas de música, gravadoras e bandas. Solte sua criatividade!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'perfume': {
    ...
    metaDescription: 'Crie o nome perfeito para sua marca de perfumes com nosso gerador gratuito por IA. Desenvolva nomes sofisticados e evocativos para fragrâncias, perfumaria e aromaterapia. Perfume sua marca!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'photography': {
    ...
    metaDescription: 'Encontre o nome perfeito para seu estúdio de fotografia com nosso gerador gratuito por IA. Crie nomes criativos e profissionais para fotógrafos, estúdios e produtoras de imagem. Capture a essência!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'print-shop': {
    ...
    metaDescription: 'Crie o nome perfeito para sua gráfica com nosso gerador gratuito por IA. Desenvolva nomes profissionais e criativos para print shops, copiadoras e serviços de impressão. Imprima sua identidade!',
...
'real-estate': {
    ...
    metaDescription: 'Crie o nome perfeito para sua imobiliária com nosso gerador gratuito por IA. Desenvolva nomes profissionais e confiáveis para corretoras, incorporadoras e empresas imobiliárias. Construa sua marca!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'shoes': {
    ...
    metaDescription: 'Crie o nome perfeito para sua loja de calçados com nosso gerador gratuito por IA. Desenvolva nomes estilosos e memoráveis para sapatarias, lojas de tênis e marcas de sapatos. Dê o primeiro passo!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'skin-care': {
    ...
    metaDescription: 'Crie o nome perfeito para sua marca de skincare com nosso gerador gratuito por IA. Desenvolva nomes sofisticados e clean para cuidados com a pele, dermocosméticos e beleza natural. Revele sua marca!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'slime': {
    ...
    metaDescription: 'Encontre o nome perfeito para sua loja de slime com nosso gerador gratuito por IA. Crie nomes divertidos e criativos para slime shops, massinhas sensoriais e produtos satisfatórios. Estique sua criatividade!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'soap': {
    ...
    metaDescription: 'Crie o nome perfeito para sua saboaria com nosso gerador gratuito por IA. Desenvolva nomes artesanais e naturais para sabonetes artesanais, produtos de banho e cosméticos naturais. Espume criatividade!',
...
'sportswear': {
    ...
    metaDescription: 'Crie o nome perfeito para sua marca de roupas esportivas com nosso gerador gratuito por IA. Desenvolva nomes dinâmicos e energéticos para activewear, moda fitness e athleisure. Acelere sua marca!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  't-shirt': {
    ...
    metaDescription: 'Crie o nome perfeito para sua marca de camisetas com nosso gerador gratuito por IA. Desenvolva nomes criativos e memoráveis para estamparias, lojas de t-shirts e marcas de streetwear. Vista sua criatividade!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'tea': {
    ...
    metaDescription: 'Crie o nome perfeito para sua marca de chá com nosso gerador gratuito por IA. Desenvolva nomes elegantes e acolhedores para casas de chá, blends especiais e infusões artesanais. Infuse sua marca!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'tech': {
    ...
    metaDescription: 'Crie o nome perfeito para sua empresa de tecnologia com nosso gerador gratuito por IA. Desenvolva nomes inovadores e memoráveis para startups, softwares e negócios tech. Inove sua marca!',
...
IMPORTANT: Generate all output in Portuguese (português brasileiro).`,
  ...
  'travel': {
    ...
    metaDescription: 'Crie o nome perfeito para sua agência de viagem com nosso gerador gratuito por IA. Desenvolva nomes inspiradores e memoráveis para operadoras de turismo, consultores de viagem e travel planners. Embarque na sua marca!',
