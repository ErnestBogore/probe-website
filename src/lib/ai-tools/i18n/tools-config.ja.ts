...
export const toolsJa: Record<string, ToolConfig> = {
  ...
  'paragraph-generator': {
    ...
    name: '段落ジェネレーター',
    title: '無料AI段落ジェネレーター | Analyze AI',
    description: '数秒で構造化された段落を生成します。ブログ記事、エッセイ、メールなどに最適。登録不要。',
    metaDescription: '無料のAI段落ジェネレーターで数秒で構造化された段落を生成。ブログ記事、エッセイ、メールなどに最適。登録不要。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
    inputLabel: '書きたいトピック...',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'paragraph-rewriter': {
    ...
    name: '段落リライター',
    title: '無料AI段落書き換えツール | Analyze AI',
    description: '元の意味を保ちながら、段落を書き換えて明確さを向上させたり、トーンを変更したり、ユニークなバリエーションを作成します。',
    metaDescription: '無料のAIツールで段落を書き換え。元の意味を保ちながら、明確さを向上させたり、トーンを変更したり、ユニークなバリエーションを作成します。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'paraphrasing-tool': {
    ...
    name: 'パラフレーズツール',
    title: '無料AIパラフレーズツール | Analyze AI',
    description: 'テキストを瞬時に言い換えます。元の意味を保ちながら文や段落を言い換えます。学生やライターに最適。',
    metaDescription: '無料のAIツールでテキストを瞬時に言い換え。元の意味を保ちながら文や段落を言い換えます。学生やライターに最適。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'sentence-rewriter': {
    ...
    name: '文章リライター',
    title: '無料AI文章書き換えツール | Analyze AI',
    description: '明確さ、インパクト、またはより良いトーンのために文章を書き換えます。説明付きの複数のバリエーションを取得。',
    metaDescription: '明確さ、インパクト、またはより良いトーンのために文章を書き換えます。各バリエーションの改善点の説明付き。無料、登録不要。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
    inputLabel: '書き換える文章...',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'summarizer': {
    slug: 'summarizer',
    name: '要約ツール',
    title: '無料AI要約ツール | Analyze AI',
    description: '長い記事、文書、テキストを明確で簡潔な要約に凝縮します。数秒で要点を抽出。',
    metaDescription: '長い記事、文書、テキストを明確で簡潔な要約に凝縮。無料のAI要約ツールで数秒で要点を抽出。今すぐお試しください。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
    inputLabel: '要約するテキスト...',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'outline-generator': {
    ...
    metaDescription: '数秒でブログ投稿、エッセイ、記事の整理されたアウトラインを生成。無料のAIアウトラインジェネレーターでアイデアを整理し、より速く書けます。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'conclusion-generator': {
    ...
    name: '結論ジェネレーター',
    title: '無料AI結論ジェネレーター | Analyze AI',
    description: '明確なテイクアウェイとCTAを含む、記事、エッセイ、ブログ投稿の説得力のある結論を生成します。',
    metaDescription: '明確なテイクアウェイとCTAを含む、記事、エッセイ、ブログ投稿の説得力のある結論を生成。無料のAIツールで満足のいく締めくくりを作成。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'lorem-ipsum-generator': {
    ...
    metaDescription: 'デザイン、モックアップ、レイアウト用のLorem Ipsumプレースホルダーテキストを生成。従来のものから現代的な代替案まで選択可能。コピー＆ペースト対応。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
    inputLabel: '必要な量...',
...
IMPORTANT: Generate all output in the appropriate language/style for the selected type.`,
  ...
  'seo-title-generator': {
    ...
    metaDescription: 'クリック率を向上させるSEO最適化タイトルを作成。無料のAIツールで数秒であらゆるウェブページに最適なメタタイトルを生成。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'meta-description-generator': {
    ...
    metaDescription: 'クリック率を向上させる魅力的なメタディスクリプションを作成。無料のAIツールであらゆるウェブページに最適化された説明を数秒で生成。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
    inputLabel: 'トピックまたはページタイトル...',
    inputPlaceholder: '例：2024年初心者向けベストランニングシューズ',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'ai-content-detector': {
    ...
    name: 'AIコンテンツ検出器',
    title: '無料AIコンテンツ検出ツール | Analyze AI',
    description: 'AI生成コンテンツを即座に検出。詳細な分析で、テキストがAIらしく見える原因を学べます。',
    metaDescription: '無料ツールでAI生成コンテンツを即座に検出。詳細な分析で、テキストがAIらしく見える原因がわかります。登録不要。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
    inputLabel: '分析するテキスト...',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'ai-text-humanizer': {
    ...
    metaDescription: 'AI生成テキストを自然で人間らしい文章に変換。無料のヒューマナイザーが元の意味を保ちながらロボット的なパターンを除去します。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'content-idea-generator': {
    ...
    metaDescription: 'ブログ、YouTube、ソーシャルメディア、ポッドキャスト、ニュースレター向けのクリエイティブなコンテンツアイデアを生成。AIがユニークな切り口でプラットフォーム最適化されたコンセプトを作成します。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'video-script-generator': {
    ...
    metaDescription: 'YouTube、TikTok、リール向けの魅力的なビデオスクリプトを生成。AIがフック、視覚的キュー、CTAを含むリテンション最適化されたスクリプトを作成します。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
    inputLabel: 'ビデオトピック...',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'acronym-generator': {
    ...
    name: '頭字語ジェネレーター',
    title: '無料AI頭字語ジェネレーター | Analyze AI',
    description: 'プロジェクト、製品、組織のための巧妙で意味のある頭字語を生成します。',
    metaDescription: 'プロジェクト、製品、組織のための巧妙で意味のある頭字語を生成。展開された意味を持つ複数のオプションを取得。無料で即座に。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
    inputLabel: '対象または概念...',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'blog-title-generator': {
    ...
    metaDescription: 'クリックを促し検索でランクインする魅力的なブログタイトルを生成。AIが実証された心理的トリガーを使用してSEO最適化されたヘッドラインを作成します。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'image-alt-text-generator': {
    ...
    metaDescription: 'アクセシビリティとSEOを改善する説明的な代替テキストを生成。任意の画像をアップロードして、検索に最適化されたスクリーンリーダーフレンドリーな説明を取得します。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'slogan-generator': {
    ...
    metaDescription: 'ブランドのエッセンスを捉えるキャッチーで記憶に残るスローガンを作成。AIが顧客の心に残るタグラインを生成します。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'product-description-generator': {
    ...
    metaDescription: '売れる魅力的な製品説明を生成。AIがEC、マーケットプレイス、カタログ向けのメリット重視のコピーを作成します。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'landing-page-generator': {
    ...
    metaDescription: 'コンバージョンする完全なランディングページコピーを生成。AIがヘッドライン、機能、テスティモニアル、FAQ、CTAをあなたのオファー用に作成します。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'google-ads-copy-generator': {
    ...
    metaDescription: 'クリックとコンバージョンを促進する高コンバージョンGoogle広告コピーを生成。AIがパフォーマンスに最適化されたヘッドラインと説明文を作成します。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
    inputLabel: '製品/サービスとオファーを説明してください...',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'hook-generator': {
    slug: 'hook-generator',
    name: 'フックジェネレーター',
    title: '無料AIフックジェネレーター | Analyze AI',
    description: 'コンテンツ用の注目を集めるフックを即座に作成。AIが読者を捕らえエンゲージメントを高める魅力的なオープニングラインを生成します。',
    metaDescription: 'コンテンツ用の注目を集めるフックを即座に作成。AIが読者を捕らえエンゲージメントを高める魅力的なオープニングラインを生成します。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'resignation-letter-generator': {
    ...
    name: '退職届ジェネレーター',
    title: '無料AI退職届ジェネレーター | Analyze AI',
    description: '数分でプロフェッショナルな退職届を作成。AIが関係を維持し評判を保護する洗練された適切な手紙を作成します。',
    metaDescription: '数分でプロフェッショナルな退職届を作成。AIが関係を維持し評判を保護する洗練された適切な手紙を作成します。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'social-media-bio-generator': {
    ...
    metaDescription: 'ソーシャルメディアプロフィール用の完璧なバイオを即座に生成。AIがパーソナルブランドを捉えフォロワーを引きつける魅力的でプロフェッショナルなバイオを作成します。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'instagram-bio-generator': {
    ...
    metaDescription: '完璧なInstagramバイオを数秒で作成。AIがフォロワーを引きつけパーソナルブランドをショーケースする魅力的で個性あふれるバイオを生成します。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
    inputLabel: '自分自身またはブランドを説明してください...',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'instagram-caption-generator': {
    ...
    metaDescription: 'いいね、コメント、シェアを促進する魅力的なInstagramキャプションを生成。AIがフィード投稿、リール、ストーリー用のスクロールを止めるキャプションを作成します。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'instagram-hashtag-generator': {
    ...
    metaDescription: 'Instagram投稿用のリーチを拡大するハッシュタグを生成。AIがフォロワーを増やし可視性を高める最適なハッシュタグを見つけます。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
    inputLabel: '投稿内容を説明してください...',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'social-media-hashtag-generator': {
    ...
    metaDescription: '複数のソーシャルプラットフォーム向けの効果的なハッシュタグを生成。AIがリーチとエンゲージメントを増やす関連タグを見つけます。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'tiktok-hashtag-generator': {
    ...
    metaDescription: 'TikTok動画のバイラル化を支援するハッシュタグを生成。AIがFor Youページにコンテンツを届けるトレンドタグを見つけます。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'social-media-username-generator': {
    ...
    metaDescription: 'ユニークで記憶に残るソーシャルメディアユーザーネームを生成。AIがパーソナルブランドを反映したクリエイティブで利用可能なハンドルを見つけます。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
    inputLabel: '自分自身またはブランドを説明してください...',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'instagram-name-generator': {
    ...
    metaDescription: '際立つユニークなInstagramユーザーネームを生成。AIがプレゼンス構築と発見を助ける記憶に残るオンブランドなハンドルを作成します。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
    inputLabel: '自分自身またはブランドを説明してください...',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'tiktok-username-generator': {
    ...
    metaDescription: 'TikTok向けのトレンディで記憶に残るユーザーネームを生成。AIがFor Youページで注目される際立つハンドルを見つけます。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'youtube-channel-description-generator': {
    ...
    metaDescription: '登録者を惹きつける魅力的なYouTubeチャンネル説明を作成。AIがコンテンツをショーケースしオーディエンスを成長させるSEO最適化された説明を生成します。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'youtube-name-generator': {
    ...
    metaDescription: '際立つクリエイティブなYouTubeチャンネル名を生成。AIが登録者を惹きつけコンテンツニッチを反映する記憶に残るブランド化可能な名前を作成します。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'youtube-video-description-generator': {
    ...
    metaDescription: 'YouTube動画用のSEO最適化された説明を生成。AIが視聴回数を増やしエンゲージメントを高める発見可能な説明を作成します。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
    inputLabel: '動画コンテンツを説明してください...',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'rewording-tool': {
    slug: 'rewording-tool',
    name: '言い換えツール',
    title: '無料AI言い換えツール | Analyze AI',
    description: 'テキストを即座に言い換え、新鮮な表現で同じ意味を伝えます。AIが文章を改善しながら元のメッセージを保持します。',
    metaDescription: 'テキストを即座に言い換え、新鮮な表現で同じ意味を伝えます。AIが文章を改善しながら元のメッセージを保持します。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
    inputLabel: '言い換えるテキスト...',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'grammar-checker': {
    ...
    name: '文法チェッカー',
    title: '無料AI文法チェッカー | Analyze AI',
    description: '文法、スペル、句読点のエラーを即座に検出して修正。AIがプロフェッショナルで洗練された文章を作成するのを支援します。',
    metaDescription: '文法、スペル、句読点のエラーを即座に検出して修正。AIがプロフェッショナルで洗練された文章を作成するのを支援します。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'plagiarism-checker': {
    ...
    name: '盗作チェッカー',
    title: '無料AI盗作チェッカー | Analyze AI',
    description: 'コンテンツの盗作と類似性をチェック。AIがテキストのオリジナリティを分析し、潜在的な問題を特定します。',
    metaDescription: 'コンテンツの盗作と類似性をチェック。AIがテキストのオリジナリティを分析し、潜在的な問題を特定します。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
    inputLabel: 'チェックするテキスト...',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'blog-post-ideas-generator': {
    ...
    metaDescription: 'あなたのニッチ向けのクリエイティブなブログ投稿アイデアを生成。AIがトラフィックを促進しオーディエンスを引きつけるトピックを見つけます。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'emoji-translator': {
    ...
    name: '絵文字翻訳',
    title: '無料AI絵文字翻訳ツール | Analyze AI',
    description: 'テキストを表現豊かな絵文字に翻訳したり、絵文字メッセージを解読します。',
    metaDescription: 'テキストを表現豊かな絵文字に翻訳したり、絵文字メッセージを解読します。ソーシャルメディア、メッセージング、楽しいコミュニケーションに最適です。無料でご利用いただけます。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'brand-name-generator': {
    ...
    metaDescription: 'ユニークで記憶に残るブランド名を即座に生成します。私たちのAIはビジネスアイデンティティのための戦略的な意味を持つ独特な名前を作成します。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'business-name-generator': {
    ...
    metaDescription: '実世界で機能するクリエイティブなビジネス名を生成します。私たちのAIはあらゆる業界向けにプロフェッショナルで記憶に残る名前を作成します。Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'product-name-generator': {
    ...
    name: '製品名ジェネレーター',
    title: '無料AI製品名ジェネレーター | Analyze AI',
    description: '売れるクリエイティブな製品名を生成します。私たちのAIは棚で際立ち、顧客の心に残る記憶に残る、市場対応の名前を作成します。',
    metaDescription: '売れるクリエイティブな製品名を生成します。私たちのAIは棚で際立ち、顧客の心に残る記憶に残る、市場対応の名前を作成します。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
    inputLabel: '製品を説明してください...',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'website-copy-generator': {
    ...
    metaDescription: '数分でプロフェッショナルなウェブサイトコンテンツを生成します。私たちのAIはホームページ、会社概要ページ、サービスページなどのコピーを作成します。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
    inputLabel: 'ビジネスを説明してください...',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'social-media-caption-generator': {
    ...
    metaDescription: 'いいね、コメント、シェアを促進する魅力的なソーシャルメディアキャプションを生成します。私たちのAIはInstagram、Facebook、Twitterなど向けの説得力のある投稿コピーを作成します。 Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
...
IMPORTANT: Generate all output in Japanese.`,
  ...
  'introduction-generator': {
    ...
    name: 'イントロダクションジェネレーター',
    title: '無料AIイントロダクションジェネレーター',
    description: '最初の一文から読者を引きつける魅力的なイントロダクションを作成。ブログ、エッセイ、記事に最適。',
    metaDescription: '最初の一文から読者を引きつける魅力的なイントロダクションを作成。無料AIツールで説得力のあるオープニングを生成。Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
    inputLabel: '記事のトピックとキーポイント...',
    inputPlaceholder: '例：トピック：リモートワークの生産性。キーポイント：柔軟性、ワークライフバランス、コミュニケーションの課題',
    buttonText: 'イントロダクションを生成',
    maxLength: 2048,
    options: [
      { name: 'contentType', label: 'コンテンツタイプ', choices: ['ブログ記事', 'ハウツーガイド', 'リスト記事', 'エッセイ/意見', '製品レビュー', '研究/レポート'], default: 'ブログ記事', type: 'select' },
      { name: 'hookType', label: 'フックタイプ', choices: ['質問', '統計', 'ストーリー', '大胆な主張', '共感'], default: '質問', type: 'select' },
      { name: 'tone', label: 'トーン', choices: ['プロフェッショナル', 'カジュアル', 'インスピレーション', 'アカデミック'], default: 'プロフェッショナル', type: 'select' },
    ],
...
IMPORTANT: Generate all output in Japanese.`,
    useCases: [
      { title: 'コンテンツマーケティングとブログのオープニング', description: '記事の書き出しに苦労するコンテンツクリエイターが、読者を即座に引きつける魅力的なオープニングを作成するために使用します。' },
      { title: 'アカデミックエッセイのイントロダクション', description: '学生がエッセイや研究論文の明確な論文を確立する構造化されたイントロダクションを生成できます。' },
      { title: 'ビジネス文書のオープニング', description: 'プロフェッショナルがレポートや提案書の重要性を即座に確立するイントロダクションを作成できます。' },
    ],
    faqs: [
      { question: '良いイントロダクションとは？', answer: '強力なイントロダクションは読者を即座に引きつけ、関連性を確立し、問題や機会を提示し、価値を約束します。' },
      { question: 'イントロダクションジェネレーターは無料ですか？', answer: 'はい、登録や支払いなしで完全に無料です。' },
      { question: 'イントロダクションの長さはどのくらいが適切ですか？', answer: 'イントロダクションは通常、コンテンツ全体の10-15%を占めます。' },
    ],
  },
  ...
  'text-expander': {
    slug: 'text-expander',
    name: 'テキストエキスパンダー',
    title: '無料AIテキストエキスパンダー',
    description: '短い文やパラグラフを、元の意味を失わずにより詳細で包括的なコンテンツに拡張します。',
    metaDescription: '短い文やパラグラフをより詳細なコンテンツに拡張。無料AIツールが意味を変えずに深みを追加。Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
    inputLabel: '拡張するテキスト...',
    inputPlaceholder: '拡張したい短いテキストをここに貼り付けてください',
    buttonText: 'テキストを拡張',
    maxLength: 2048,
    options: [
      { name: 'expansionLevel', label: '拡張レベル', choices: ['ライト（1.5倍）', 'モデレート（2倍）', 'サブスタンシャル（3倍）'], default: 'モデレート（2倍）', type: 'select' },
      { name: 'method', label: '拡張方法', choices: ['例を追加', '説明を追加', '詳細を追加', 'バランス'], default: 'バランス', type: 'select' },
      { name: 'tone', label: 'トーン', choices: ['フォーマル', 'カジュアル', 'アカデミック', 'プロフェッショナル'], default: 'プロフェッショナル', type: 'select' },
    ],
...
## CORE RULES
- Preserve the original meaning completely
- Add substantive content, not filler
...
IMPORTANT: Generate all output in Japanese.`,
    useCases: [
      { title: 'コンテンツ開発と文字数目標', description: '文字数要件を満たす必要があるライターが、簡潔なアイデアを完全なコンテンツに発展させるために使用します。' },
      { title: 'キーポイントの詳細化', description: 'プロフェッショナルが箇条書きやアウトラインを完全な散文に拡張できます。' },
      { title: 'アカデミックライティング', description: '学生が初期の議論を証拠と分析を含む完全に発展したパラグラフに拡張できます。' },
    ],
    faqs: [
      { question: 'テキストエキスパンダーとは？', answer: '短いコンテンツを取り、意味のある例、説明、詳細を含むより詳細で包括的なテキストに拡張するツールです。' },
      { question: 'テキストエキスパンダーは無料ですか？', answer: 'はい、登録なしで完全に無料です。' },
      { question: '元の意味は保たれますか？', answer: '元の意味の保持は核心的なルールです。拡張されたコンテンツは常にポイントを強化し、詳述します。' },
    ],
  },

  'youtube-video-title-generator': {
    slug: 'youtube-video-title-generator',
    name: 'YouTube動画タイトルジェネレーター',
    title: '無料AI YouTube動画タイトルジェネレーター',
    description: '視聴回数を獲得するクリック力のあるYouTube動画タイトルを生成。AIがSEO最適化されたタイトルを作成します。',
    metaDescription: '視聴回数を獲得するYouTube動画タイトルを生成。AIがSEO最適化されたタイトルを作成。Analyze AIで今すぐこの無料ツールや他の無料ツールをお試しください。',
    inputLabel: '動画のトピックを説明してください...',
    inputPlaceholder: '例：ポートレート写真編集のLightroomチュートリアル',
    buttonText: 'タイトルを生成',
    maxLength: 2048,
    options: [
      { name: 'style', label: 'タイトルスタイル', choices: ['情報的/明確', 'キャッチー/クリックベイト', '質問', 'リスト/数字', 'ハウツー'], default: '情報的/明確', type: 'select' },
      { name: 'video_type', label: '動画タイプ', choices: ['チュートリアル/教育', 'エンターテインメント/Vlog', 'レビュー/製品', 'ゲーミング', 'ニュース/コメンタリー'], default: 'チュートリアル/教育', type: 'select' },
    ],
...
IMPORTANT: Generate all output in Japanese.`,
    useCases: [
      { title: 'クリック率の最適化', description: 'YouTubeクリエイターがクリック率を最大化するタイトルを作成するために使用します。' },
      { title: '動画SEOの改善', description: 'キーワード最適化されたタイトルで検索可視性を向上させます。' },
      { title: 'タイトルのA/Bテスト', description: '異なるタイトルアプローチをテストして最適なものを見つけます。' },
    ],
    faqs: [
      { question: 'YouTube動画タイトルの長さはどのくらいが適切ですか？', answer: 'YouTubeは最大100文字を許可しますが、検索結果での完全な表示のために60-70文字を目指してください。' },
      { question: 'タイトルはYouTube SEOに影響しますか？', answer: 'はい、タイトルは最も重要なランキング要因の一つです。' },
    ],
  },
};
