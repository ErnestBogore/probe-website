...
export const toolsPt: Record<string, ToolConfig> = {
  ...
  'paragraph-generator': {
    ...
    metaDescription: 'Crie parágrafos bem estruturados instantaneamente com nosso gerador de parágrafos por IA gratuito. Gere conteúdo claro e coeso sobre...',
...
IMPORTANT: Generate all output in Portuguese.`,
  ...
  'paragraph-rewriter': {
    ...
    metaDescription: 'Transforme parágrafos existentes em conteúdo fresco e original com nosso reescritor por IA gratuito. Mantenha o significado original...',
...
IMPORTANT: Generate all output in Portuguese.`,
  ...
  'paraphrasing-tool': {
    ...
    metaDescription: 'Parafraseie texto instantaneamente com nossa ferramenta de paráfrase por IA gratuita. Transforme qualquer conteúdo em escrita original e...',
...
IMPORTANT: Generate all output in Portuguese.`,
  ...
  'sentence-rewriter': {
    ...
    metaDescription: 'Reescreva frases para maior clareza, impacto ou melhor tom. Obtenha múltiplas variações com explicações do que torna cada uma mais forte....',
...
IMPORTANT: Generate all output in Portuguese.`,
  ...
  'summarizer': {
    ...
    metaDescription: 'Resuma textos longos instantaneamente com nossa ferramenta de resumo por IA gratuita. Extraia pontos-chave e informações essenciais de...',
...
IMPORTANT: Generate all output in Portuguese.`,
  ...
  'outline-generator': {
    ...
    metaDescription: 'Crie esboços estruturados para artigos, ensaios e apresentações instantaneamente. Nossa IA organiza suas ideias em estruturas lógicas e...',
...
IMPORTANT: Generate all output in Portuguese.`,
  ...
  'conclusion-generator': {
    ...
    metaDescription: 'Crie conclusões convincentes para ensaios, artigos e relatórios. Nossa IA gera finais impactantes que resumem pontos-chave e deixam...',
...
IMPORTANT: Generate all output in Portuguese.`,
  ...
  'lorem-ipsum-generator': {
    ...
    metaDescription: 'Gere texto de espaço reservado para designs e layouts. Nosso gerador Lorem Ipsum cria texto de preenchimento profissional para web design e...',
...
IMPORTANT: Generate all output in Portuguese.`,
  ...
  'seo-title-generator': {
    ...
    metaDescription: 'Crie títulos de página otimizados para SEO que rankam e convertem. Nossa IA gera tags de título atraentes que equilibram otimização de...',
...
IMPORTANT: Generate all output in Portuguese.`,
  ...
  'ai-content-detector': {
    ...
    metaDescription: 'Detecte conteúdo gerado por IA com nossa ferramenta gratuita. Analise texto para identificar escrita por IA versus humana com explicações...',
...
IMPORTANT: Generate all output in Portuguese.`,
  ...
  'content-idea-generator': {
    ...
    metaDescription: 'Gere ideias de conteúdo criativas para blogs, redes sociais e marketing. Nossa IA fornece tópicos únicos e ângulos que ressoam com seu...',
...
IMPORTANT: Generate all output in Portuguese.`,
  ...
  'social-media-username-generator': {
    ...
    metaDescription: 'Crie nomes de usuário únicos e memoráveis para suas redes sociais. Nossa IA gera ideias personalizadas que funcionam no Instagram, TikTok,...',
    inputLabel: 'Descreva você ou sua marca...',
...
IMPORTANT: Generate all output in Portuguese.`,
  ...
  'blog-post-ideas-generator': {
    ...
    metaDescription: 'Sem ideias de conteúdo? Gere ideias de posts de blog únicos e otimizados para SEO em segundos. Nossa IA entrega tópicos prontos para...',
...
IMPORTANT: Generate all output in Portuguese.`,
  ...
  'emoji-translator': {
    ...
    metaDescription: 'Traduza texto em emojis expressivos ou decodifique mensagens de emoji. Perfeito para redes sociais, mensagens e comunicação divertida....',
...
IMPORTANT: Generate all output in Portuguese.`,
  ...
  'brand-name-generator': {
    ...
    metaDescription: 'Crie nomes de marca únicos e memoráveis instantaneamente. Nossa IA gera nomes distintivos com significado estratégico para sua identidade...',
...
IMPORTANT: Generate all output in Portuguese.`,
  ...
  'social-media-caption-generator': {
    ...
    metaDescription: 'Gere legendas de mídia social envolventes que geram likes, comentários e compartilhamentos. Nossa IA cria textos atraentes para Instagram,...',
    inputLabel: 'Descreva seu post...',
