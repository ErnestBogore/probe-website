...
IMPORTANT: Generate all output in German.`,
  ...
  'paragraph-rewriter': {
    ...
    metaDescription: 'Formulieren Sie Absätze um, um Klarheit, Ton oder Einzigartigkeit zu verbessern. Behalten Sie die Bedeutung bei und verbessern Sie Ihren Text.',
...
IMPORTANT: Generate all output in German.`,
  ...
  'paraphrasing-tool': {
    ...
    metaDescription: 'Formulieren Sie jeden Text in Sekunden um. Behalten Sie die Bedeutung bei, verbessern Sie den Stil und vermeiden Sie Plagiate mit KI-gestütztem Paraphrasieren.',
...
IMPORTANT: Generate all output in German.`,
  ...
  'sentence-rewriter': {
    ...
    metaDescription: 'Formulieren Sie Sätze für Klarheit, Wirkung oder besseren Ton um. Erhalten Sie mehrere Varianten mit Erklärungen dessen, was jede stärker macht. Kostenlos, keine Anmeldung.',
...
IMPORTANT: Generate all output in German.`,
  ...
  'lorem-ipsum-generator': {
    ...
    metaDescription: 'Generieren Sie Lorem Ipsum Platzhaltertext für Designs, Mockups und Layouts. Wählen Sie traditionelle oder moderne Alternativen. Sofort kopierbar.',
...
Generate the requested placeholder text, ready to copy-paste.`,
  ...
  'seo-title-generator': {
    ...
    metaDescription: 'Generieren Sie suchoptimierte Titel-Tags, die höher ranken und mehr Klicks erhalten. Unsere KI erstellt perfekt dimensionierte Titel mit Keywords an den richtigen Positionen.',
...
IMPORTANT: Generate all output in German.`,
  ...
  'meta-description-generator': {
    ...
    metaDescription: 'Erstellen Sie überzeugende Meta-Beschreibungen, die Klicks erzielen. Unsere KI schreibt SEO-optimierte Beschreibungen mit der perfekten Länge und Keywords.',
...
IMPORTANT: Generate all output in German.`,
  ...
  'ai-content-detector': {
    ...
    metaDescription: 'Erkennen Sie, ob Text von einer KI geschrieben wurde. Analysieren Sie Inhalte auf charakteristische KI-Muster und erhalten Sie Konfidenzwerte.',
...
IMPORTANT: Generate all output in German.`,
  ...
  'content-idea-generator': {
    ...
    metaDescription: 'Generieren Sie kreative Content-Ideen für Blogs, Social Media und Marketing. Überwinden Sie Schreibblockaden mit KI-generierten Themenvorschlägen.',
...
IMPORTANT: Generate all output in German.`,
  ...
  'acronym-generator': {
    ...
    metaDescription: 'Generieren Sie clevere, bedeutungsvolle Akronyme für Projekte, Produkte und Organisationen. Erhalten Sie mehrere Optionen mit erweiterten Bedeutungen. Kostenlos und sofort.',
...
IMPORTANT: Generate all output in German.`,
  ...
  'landing-page-generator': {
    ...
    metaDescription: 'Erstellen Sie konversionsstarke Landingpage-Texte. Unsere KI schreibt überzeugende Headlines, Vorteile und Calls-to-Action für höhere Konversionen.',
...
IMPORTANT: Generate all output in German.`,
  ...
  'resignation-letter-generator': {
    ...
    metaDescription: 'Schreiben Sie ein professionelles Kündigungsschreiben in Minuten. Unsere KI erstellt höfliche Schreiben, die Beziehungen erhalten und Ihren Ruf schützen.',
...
IMPORTANT: Generate all output in German.`,
  ...
  'social-media-username-generator': {
    ...
    metaDescription: 'Erstellen Sie einzigartige, einprägsame Benutzernamen für Ihre Social-Media-Profile. Unsere KI kreiert personalisierte Benutzernamen-Ideen, die auf Instagram, TikTok, Twitter und mehr funktionieren.',
...
IMPORTANT: Generate all output in German.`,
  ...
  'instagram-name-generator': {
    ...
    metaDescription: 'Erstellen Sie einzigartige Instagram-Benutzernamen, die herausstechen. Unsere KI kreiert einprägsame, markenkonforme Handles, die Ihnen helfen, Ihre Präsenz aufzubauen und entdeckt zu werden.',
    inputLabel: 'Beschreiben Sie sich oder Ihre Marke...',
...
IMPORTANT: Generate all output in German.`,
  ...
  'tiktok-username-generator': {
    ...
    metaDescription: 'Erstellen Sie einzigartige TikTok-Benutzernamen, die zu Ihrem Vibe passen. Unsere KI kreiert einprägsame, trendige Handles, die Ihnen helfen, sich abzuheben und Ihre Followerschaft zu vergrößern.',
...
IMPORTANT: Generate all output in German.`,
  ...
  'youtube-channel-description-generator': {
    ...
    metaDescription: 'Erstellen Sie eine überzeugende YouTube-Kanal-Beschreibung, die Abonnenten anzieht. Unsere KI generiert SEO-optimierte Beschreibungen, die Ihren Content präsentieren und Ihr Publikum vergrößern.',
...
IMPORTANT: Generate all output in German.`,
  ...
  'youtube-name-generator': {
    ...
    metaDescription: 'Generieren Sie kreative YouTube-Kanalnamen, die herausstechen. Unsere KI erstellt einprägsame, markenfähige Namen, die Abonnenten anziehen und Ihre Content-Nische widerspiegeln.',
...
IMPORTANT: Generate all output in German.`,
  ...
  'youtube-video-description-generator': {
    ...
    metaDescription: 'Generieren Sie SEO-optimierte YouTube-Beschreibungen, die Views steigern. Unsere KI erstellt überzeugende Beschreibungen mit Hooks, Zeitstempeln und Keywords, die Videos höher ranken lassen.',
...
IMPORTANT: Generate all output in German.`,
  ...
  'rewording-tool': {
    ...
    metaDescription: 'Formulieren Sie Text sofort mit unserem KI-Tool um. Transformieren Sie Sätze und Absätze für bessere Klarheit, anderen Ton oder einzigartigen Content.',
...
IMPORTANT: Generate all output in German.`,
  ...
  'grammar-checker': {
    ...
    metaDescription: 'Prüfen Sie Ihre Grammatik, Rechtschreibung und Zeichensetzung kostenlos. Erhalten Sie sofortige Korrekturen mit klaren Erklärungen zur Verbesserung Ihrer Schreibfähigkeiten.',
...
IMPORTANT: Generate all output in German.`,
  ...
  'plagiarism-checker': {
    ...
    metaDescription: 'Analysieren Sie Ihren Content auf Originalität und identifizieren Sie Passagen, die möglicherweise Zitate oder Umschreibung benötigen. Erhalten Sie handlungsrelevantes Feedback zur Verbesserung Ihres Schreibens.',
    inputLabel: 'Text zur Prüfung...',
...
IMPORTANT: Generate all output in German.`,
  ...
  'emoji-translator': {
    ...
    metaDescription: 'Übersetzen Sie Text in ausdrucksstarke Emojis oder entschlüsseln Sie Emoji-Nachrichten. Perfekt für Social Media, Messaging und lustige Kommunikation. Kostenlos nutzbar.',
...
IMPORTANT: Generate all output in German.`,
  ...
  'brand-name-generator': {
    ...
    metaDescription: 'Erstellen Sie einzigartige, einprägsame Markennamen sofort. Unsere KI kreiert markante Namen mit strategischer Bedeutung für Ihre Geschäftsidentität.',
...
IMPORTANT: Generate all output in German.`,
  ...
  'business-name-generator': {
    ...
    metaDescription: 'Generieren Sie kreative Geschäftsnamen, die in der realen Welt funktionieren. Unsere KI erstellt professionelle, einprägsame Namen für jede Branche.',
...
IMPORTANT: Generate all output in German.`,
  ...
  'product-name-generator': {
    ...
    metaDescription: 'Generieren Sie kreative Produktnamen, die verkaufen. Unsere KI erstellt einprägsame, marktreife Namen, die im Regal und im Kopf der Kunden herausstechen.',
...
IMPORTANT: Generate all output in German.`,
  ...
  'website-copy-generator': {
    ...
    metaDescription: 'Generieren Sie professionelle Website-Inhalte in Minuten. Unsere KI erstellt Texte für Startseiten, Über-uns-Seiten, Leistungsseiten und mehr.',
    inputLabel: 'Beschreiben Sie Ihr Unternehmen...',
...
IMPORTANT: Generate all output in German.`,
  ...
  'social-media-caption-generator': {
    ...
    metaDescription: 'Generieren Sie ansprechende Social-Media-Bildunterschriften, die Likes, Kommentare und Shares antreiben. Unsere KI erstellt überzeugende Post-Texte für Instagram, Facebook, Twitter und mehr.',
