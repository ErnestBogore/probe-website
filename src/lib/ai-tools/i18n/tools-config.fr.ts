...
export const toolsFr: Record<string, ToolConfig> = {
  'generateur-de-paragraphe': {
    ...
    metaDescription: 'Générez des paragraphes bien structurés en quelques secondes avec notre générateur de paragraphe IA gratuit. Parfait pour les articles de...',
...
Self-check before output: Read the paragraph mentally. If any sentence feels like filler or could be deleted without losing meaning, rewrite it. If the paragraph could apply to any generic article, add a specific detail or example.`,
  ...
  'reformulateur-de-paragraphe': {
    ...
    metaDescription: 'Reformulez vos paragraphes avec notre outil IA gratuit. Améliorez la clarté, changez le ton ou créez des variations uniques de votre texte...',
...
Self-check before output: If someone read only the paraphrase, would they understand exactly the same thing as if they read the original? If not, revise. If the paraphrase is too similar (just swapped a few words), transform it more substantially.`,
  ...
  'outil-de-resume': {
    ...
    metaDescription: 'Condensez de longs articles, documents et textes en résumés clairs et concis. Notre outil de résumé IA gratuit extrait les points clés en...',
...
Self-check before output: Could someone who only reads the summary understand the essential message of the original? Is any critical information missing? Is any included information not actually important? Revise if needed.`,
  ...
  'generateur-de-titres-de-blog': {
    ...
    metaDescription: 'Générez des titres de blog percutants qui attirent les clics et se classent dans les recherches. Notre IA crée des titres optimisés pour le...',
...
End with recommendation of strongest option for SEO vs. social sharing.`,
  ...
  'generateur-de-plan': {
    ...
    metaDescription: 'Générez des plans structurés pour articles de blog, essais et articles en quelques secondes. Notre générateur de plan IA gratuit vous aide...',
...
IMPORTANT: Generate all output in French.`,
  ...
  'generateur-de-conclusion': {
    ...
    metaDescription: 'Générez des conclusions percutantes pour tout article, essai ou post de blog. Notre outil IA gratuit crée des fins satisfaisantes avec des...',
...
IMPORTANT: Generate all content in French.`,
  ...
  'verificateur-de-grammaire': {
    ...
    metaDescription: 'Vérifiez votre grammaire, orthographe et ponctuation gratuitement. Obtenez des corrections instantanées avec des explications claires pour...',
...
IMPORTANT: Generate all output in French.`,
  ...
  'generateur-acronymes': {
    ...
    metaDescription: 'Générez des acronymes astucieux et significatifs pour vos projets, produits et organisations. Obtenez plusieurs options avec les...',
...
IMPORTANT: Generate all output in French.`,
  ...
  'generateur-lorem-ipsum': {
    ...
    metaDescription: 'Générez du texte de remplissage lorem ipsum pour vos designs, maquettes et mises en page. Choisissez entre traditionnel ou alternatives...',
...
IMPORTANT: Generate all output in French.`,
  ...
  'generateur-titres-seo': {
    ...
    metaDescription: 'Générez des balises de titre optimisées pour la recherche qui se classent mieux et obtiennent plus de clics. Notre IA crée des titres...',
...
IMPORTANT: Generate all output in French.`,
  ...
  'generateur-idees-contenu': {
    ...
    metaDescription: 'Générez des idées de contenu créatives pour blogs, YouTube, réseaux sociaux, podcasts et newsletters. Notre IA crée des concepts optimisés...',
    inputLabel: 'Sujet ou niche...',
...
IMPORTANT: Generate all output in French.`,
  ...
  'generateur-script-video': {
    ...
    metaDescription: 'Créez des scripts vidéo professionnels pour YouTube, TikTok et les réseaux sociaux. Notre IA génère du contenu structuré et engageant qui...',
...
IMPORTANT: Generate all output in French.`,
  ...
  'generateur-nom-marque': {
    ...
    metaDescription: 'Générez des noms de marque uniques et mémorables instantanément. Notre IA crée des noms distinctifs avec une signification stratégique pour...',
...
IMPORTANT: Generate all output in French. Create French business names appropriate for the francophone market.`,
  ...
  'generateur-nom-produit': {
    ...
    metaDescription: 'Générez des noms de produits créatifs qui vendent. Notre IA crée des noms mémorables et prêts pour le marché qui se démarquent en rayon et...',
...
IMPORTANT: Generate all output in French. Create compelling French product descriptions.`,
  ...
  'generateur-page-destination': {
    ...
    metaDescription: 'Générez des textes de landing page complets qui convertissent. Notre IA crée titres, caractéristiques, témoignages, FAQ et CTA pour votre...',
    inputLabel: 'Décrivez votre produit/service et offre...',
...
IMPORTANT: Generate all output in French.`,
  ...
  'generateur-lettre-demission': {
    ...
    metaDescription: 'Rédigez une lettre de démission professionnelle en quelques minutes. Notre IA crée des lettres soignées et appropriées qui préservent les...',
...
IMPORTANT: Generate all output in French.`,
  ...
  'generateur-bio-reseaux-sociaux': {
    ...
    metaDescription: 'Générez la bio parfaite pour vos profils de réseaux sociaux instantanément. Notre IA crée des bios engageantes et professionnelles qui...',
...
IMPORTANT: Generate all output in French.`,
  ...
  'generateur-bio-instagram': {
    ...
    metaDescription: 'Créez la bio Instagram parfaite en quelques secondes. Notre IA génère des bios engageantes et pleines de personnalité qui attirent les...',
    inputLabel: 'Décrivez-vous ou votre marque...',
...
IMPORTANT: Generate all output in French.`,
  ...
  'generateur-legende-reseaux-sociaux': {
    ...
    metaDescription: 'Générez des légendes engageantes qui génèrent likes, commentaires et partages. Notre IA crée des textes de publication percutants pour...',
...
IMPORTANT: Generate all output in French.`,
  ...
  'generateur-legende-instagram': {
    ...
    metaDescription: 'Créez des légendes Instagram qui arrêtent le scroll instantanément. Notre IA génère des légendes engageantes pour Reels, carrousels et...',
...
IMPORTANT: Generate all output in French.`,
  ...
  'generateur-hashtag-reseaux-sociaux': {
    ...
    metaDescription: 'Générez des hashtags efficaces qui boostent votre portée et engagement. Notre IA crée des ensembles de hashtags stratégiques pour...',
...
IMPORTANT: Generate all output in French.`,
  ...
  'generateur-hashtag-instagram': {
    ...
    metaDescription: 'Générez les hashtags Instagram parfaits pour booster votre portée et engagement. Notre IA crée des ensembles de hashtags stratégiques...',
...
IMPORTANT: Generate all output in French.`,
  ...
  'generateur-hashtag-tiktok': {
    ...
    metaDescription: 'Générez des hashtags TikTok tendance qui boostent votre visibilité. Notre IA crée des combinaisons de hashtags stratégiques pour aider vos...',
...
IMPORTANT: Generate all output in French.`,
  ...
  'generateur-description-chaine-youtube': {
    ...
    metaDescription: 'Créez une description de chaîne YouTube convaincante qui attire les abonnés. Notre IA génère des descriptions optimisées SEO qui mettent en...',
...
IMPORTANT: Generate all output in French.`,
  ...
  'generateur-description-video-youtube': {
    ...
    metaDescription: 'Générez des descriptions YouTube optimisées SEO qui boostent les vues. Notre IA crée des descriptions convaincantes avec accroches,...',
...
IMPORTANT: Generate all output in French.`,
  ...
  'generateur-titre-video-youtube': {
    ...
    metaDescription: 'Générez des titres YouTube accrocheurs qui obtiennent des clics. Notre IA crée des titres optimisés SEO qui attirent les spectateurs et...',
...
IMPORTANT: Generate all output in French.`,
  ...
  'outil-reformulation': {
    ...
    metaDescription: 'Reformulez et paraphrasez du texte instantanément avec notre outil IA. Transformez des phrases et paragraphes pour améliorer la clarté,...',
