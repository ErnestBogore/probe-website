...
export const toolsZh: Record<string, ToolConfig> = {
  ...
  'paragraph-generator': {
    ...
    metaDescription: '使用我们的AI驱动工具即时创建高质量段落。完美适用于论文、博客、电子邮件等。节省时间，提高写作水平。',
    inputLabel: '段落主题或想法',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'paragraph-rewriter': {
    ...
    metaDescription: '使用我们的免费AI工具改造段落。获得清晰保留含义的新鲜措辞。非常适合论文、电子邮件和博客。',
    inputLabel: '要重写的段落',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'paraphrasing-tool': {
    ...
    metaDescription: '免费转述文本，同时保留原意。非常适合学生、作家和专业人士。AI驱动的清晰结果。',
    inputLabel: '要转述的文本',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'sentence-rewriter': {
    ...
    metaDescription: '使用我们的AI工具免费改写句子。提高清晰度，改变语气，或简化语言，同时保持您的含义。',
    inputLabel: '要重写的句子',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'summarizer': {
    ...
    metaDescription: '使用AI免费总结文章、论文和文档。获取清晰、简洁的摘要，节省您的时间，同时捕获关键点。',
    inputLabel: '要摘要的文本',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'outline-generator': {
    ...
    metaDescription: '使用AI即时生成结构化大纲。组织论文、博客文章和演示文稿。免费且易于使用。',
    inputLabel: '主题或标题',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'conclusion-generator': {
    ...
    metaDescription: '使用AI即时生成引人注目的结论。完美适用于论文、博客和商业写作。免费且易于使用。',
    inputLabel: '主要点或内容摘要',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'lorem-ipsum-generator': {
    ...
    metaDescription: '为网页设计和布局生成Lorem Ipsum占位文本。可自定义段落、句子或单词数量。免费且即时。',
    inputLabel: '数量',
...
IMPORTANT: Generate all output in the requested Lorem Ipsum style.`,
  ...
  'seo-title-generator': {
    ...
    metaDescription: '使用AI生成SEO优化的标题。提高点击率并提高搜索排名。免费用于博客、文章等。',
    inputLabel: '主题或关键词',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'meta-description-generator': {
    ...
    metaDescription: '使用AI生成SEO优化的元描述。提高搜索片段的点击率。免费且即时。',
    inputLabel: '页面主题或内容',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'ai-content-detector': {
    ...
    metaDescription: '免费检测AI生成的内容。分析文本以了解它是由人类还是AI编写的。适用于教育工作者、编辑和内容验证。',
    inputLabel: '要分析的文本',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'ai-text-humanizer': {
    ...
    metaDescription: '使AI生成的内容听起来更自然和人类化。保留意义的同时改善可读性和真实性。免费且即时。',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'content-idea-generator': {
    ...
    metaDescription: '为博客、视频和社交媒体生成创意内容想法。适用于营销人员和创作者的AI驱动建议。免费使用。',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'video-script-generator': {
    ...
    metaDescription: '为YouTube、TikTok和社交媒体生成视频脚本。AI驱动的脚本写作具有引人入胜的结构。免费使用。',
    inputLabel: '视频主题或概念',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'acronym-generator': {
    ...
    metaDescription: '为项目和想法生成智能、记忆深刻的缩写词。AI驱动的缩写创建。免费且即时。',
    inputLabel: '描述您的概念',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'blog-title-generator': {
    ...
    metaDescription: '为您的博客文章生成SEO友好的、引人入胜的标题。AI驱动的标题创建。免费且即时。',
    inputLabel: '博客主题',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'image-alt-text-generator': {
    ...
    name: '图片Alt文本生成器',
    title: '免费AI图片Alt文本生成器',
    description: '为您的图片创建SEO友好的替代文本描述。改善可访问性并增强搜索引擎可见性。',
    metaDescription: '使用AI为图片生成描述性的alt文本。改善网站可访问性和SEO。免费且即时。',
    inputLabel: '描述您的图片',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'slogan-generator': {
    ...
    metaDescription: '为您的品牌或产品生成朗朗上口的口号和标语。AI驱动的创意口号创建。免费且即时。',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'product-description-generator': {
    ...
    metaDescription: '为电子商务生成有说服力的产品描述。AI驱动的文案改善销售。免费且即时。',
    inputLabel: '产品详情',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'landing-page-generator': {
    ...
    metaDescription: '生成驱动转化的落地页文案。AI驱动的有说服力写作。免费且即时。',
    inputLabel: '产品/服务详情',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'google-ads-copy-generator': {
    ...
    metaDescription: '创建驱动点击和转化的Google广告文案。AI驱动的广告文案优化。免费且即时。',
    inputLabel: '产品/服务和优惠',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'hook-generator': {
    ...
    metaDescription: '生成抓住注意力的内容钩子。AI驱动的开场白创建。免费且即时。',
    inputLabel: '内容主题',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'resignation-letter-generator': {
    ...
    metaDescription: '几分钟内写出专业的辞职信。AI驱动的信函撰写。免费且即时。',
    inputLabel: '描述您的情况',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'social-media-bio-generator': {
    ...
    metaDescription: '为社交媒体资料生成引人入胜的简介。AI驱动的个人品牌。免费且即时。',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'instagram-bio-generator': {
    ...
    metaDescription: '生成吸引粉丝的引人入胜的Instagram简介。AI驱动的简介创建。免费且即时。',
    inputLabel: '描述您自己或您的品牌',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'instagram-caption-generator': {
    ...
    metaDescription: '生成驱动参与的Instagram标题。AI驱动的标题创建。免费且即时。',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'instagram-hashtag-generator': {
    ...
    metaDescription: '为您的帖子生成战略性Instagram标签。AI驱动的标签优化。免费且即时。',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'social-media-hashtag-generator': {
    ...
    metaDescription: '为所有平台生成战略性社交媒体标签。AI驱动的标签优化。免费且即时。',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'tiktok-hashtag-generator': {
    ...
    metaDescription: '为您的视频生成走红的TikTok标签。AI驱动的TikTok标签优化。免费且即时。',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'social-media-username-generator': {
    ...
    name: '社交媒体用户名生成器',
    title: '免费AI社交媒体用户名生成器',
    description: '创建在每个平台上脱颖而出的独特、易记的用户名。我们的AI帮助您找到反映您品牌的完美句柄。',
    metaDescription: '为社交媒体资料生成独特的用户名。AI驱动的用户名建议。免费且即时。',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'instagram-name-generator': {
    ...
    metaDescription: '为您的资料生成独特的Instagram用户名。AI驱动的用户名建议。免费且即时。',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'tiktok-username-generator': {
    ...
    metaDescription: '为您的资料生成独特的TikTok用户名。AI驱动的用户名建议。免费且即时。',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'youtube-channel-description-generator': {
    ...
    metaDescription: '生成驱动订阅的YouTube频道描述。AI驱动的频道描述优化。免费且即时。',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'youtube-name-generator': {
    ...
    metaDescription: '生成独特的YouTube频道名称。AI驱动的频道名称建议。免费且即时。',
    inputLabel: '描述您的频道内容',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'youtube-video-description-generator': {
    ...
    metaDescription: '生成SEO优化的YouTube视频描述。AI驱动的描述创建。免费且即时。',
    inputLabel: '描述您的视频内容',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'rewording-tool': {
    ...
    metaDescription: '使用AI免费改写文本。保持含义的同时获得新鲜措辞。非常适合论文、电子邮件和博客。',
    inputLabel: '要改写的文本',
    inputPlaceholder: '在这里输入或粘贴您的文本...',
    buttonText: '改写',
    maxLength: 4096,
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'grammar-checker': {
    ...
    metaDescription: '使用AI免费检查语法、标点和写作风格。立即改善您的写作。',
    inputLabel: '要检查的文本',
    inputPlaceholder: '在这里输入或粘贴您的文本...',
    buttonText: '检查语法',
    maxLength: 8192,
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'plagiarism-checker': {
    ...
    metaDescription: '分析您的内容的原创性，识别可能需要引用或改写的段落。获得可操作的反馈来改善您的写作。',
    inputLabel: '要检查的文本',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'blog-post-ideas-generator': {
    ...
    metaDescription: '为内容创意而苦恼？在几秒钟内生成独特的、SEO优化的博客文章创意。我们的AI提供准备写作的主题。',
    inputLabel: '主题或利基',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'emoji-translator': {
    ...
    metaDescription: '将文本翻译成表达丰富的表情符号或解码表情符号消息。非常适合社交媒体、消息传递和有趣的沟通。免费使用。',
    inputLabel: '文本或表情符号...',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'brand-name-generator': {
    ...
    metaDescription: '即时生成独特、令人难忘的品牌名称。我们的AI为您的商业身份创建具有战略意义的独特名称。',
    inputLabel: '描述您的品牌...',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'business-name-generator': {
    ...
    metaDescription: '生成在现实世界中有效的创意企业名称。我们的AI为任何行业创建专业、令人难忘的名称。',
    inputLabel: '描述您的企业...',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'product-name-generator': {
    ...
    metaDescription: '生成畅销的创意产品名称。我们的AI创建令人难忘、市场就绪的名称，在货架上和客户心中脱颖而出。',
    inputLabel: '描述您的产品...',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'website-copy-generator': {
    ...
    metaDescription: '几分钟内生成专业的网站内容。我们的AI为首页、关于页面、服务页面等创建文案。',
    inputLabel: '描述您的企业...',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'social-media-caption-generator': {
    ...
    metaDescription: '生成推动点赞、评论和分享的引人入胜的社交媒体标题。我们的AI为Instagram、Facebook、Twitter等创建引人注目的帖子文案。',
    inputLabel: '描述您的帖子内容...',
