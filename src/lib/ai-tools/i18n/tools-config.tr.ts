...
export const toolsTr: Record<string, ToolConfig> = {
  ...
  'paragraph-generator': {
    ...
    metaDescription: 'Ücretsiz AI paragraf oluşturucumuzla saniyeler içinde iyi yapılandırılmış paragraflar oluşturun. Blog yazıları, makaleler, e-postalar ve...',
    inputLabel: 'Konu...',
...
IMPORTANT: Generate all output in Turkish.`,
  ...
  'paragraph-rewriter': {
    ...
    metaDescription: 'Ücretsiz AI paragraf yeniden yazıcımızla paragraflarınızı anında dönüştürün. Orijinal anlamı korurken netlik, ton ve okunabilirliği...',
...
IMPORTANT: Generate all output in Turkish.`,
  ...
  'meta-description-generator': {
    ...
    metaDescription: 'Ücretsiz AI aracımızla tıklamaları artıran, SEO için optimize edilmiş meta açıklamalar oluşturun. Arama sonuçlarında öne çıkan ilgi çekici...',
...
IMPORTANT: Generate all output in Turkish.`,
  ...
  'paraphrasing-tool': {
    ...
    metaDescription: 'Ücretsiz AI parafraz aracımızla herhangi bir metni anında yeniden ifade edin. Orijinal anlamı korurken cümleler ve paragraflar için...',
    inputLabel: 'Metin...',
...
IMPORTANT: Generate all output in Turkish.`,
  ...
  'summarizer': {
    ...
    metaDescription: 'Ücretsiz AI özetleyicimizle uzun metinleri anında kısa, net özetlere dönüştürün. Makalelerin, belgelerin ve daha fazlasının ana noktalarını...',
...
IMPORTANT: Generate all output in Turkish.`,
  ...
  'outline-generator': {
    ...
    metaDescription: 'Ücretsiz AI aracımızla kapsamlı içerik taslakları oluşturun. Makaleler, blog yazıları ve daha fazlası için yapılandırılmış çerçeveler...',
...
IMPORTANT: Generate all output in Turkish.`,
  ...
  'ai-content-detector': {
    ...
    metaDescription: 'Ücretsiz AI içerik dedektörümüzle metnin AI tarafından mı yoksa insan tarafından mı yazıldığını tespit edin. Makine tarafından oluşturulan...',
...
IMPORTANT: Generate all output in Turkish.`,
  ...
  'ai-text-humanizer': {
    ...
    metaDescription: 'Ücretsiz AI metin insanlaştırıcımızla AI tarafından oluşturulan metni daha doğal, insan yazısına dönüştürün. İçeriği özgün hissettiren bir...',
...
IMPORTANT: Generate all output in Turkish.`,
  ...
  'conclusion-generator': {
    ...
    metaDescription: 'Ücretsiz AI aracımızla yazılarınız için güçlü sonuç paragrafları oluşturun. İçeriğinizi etkili bir şekilde tamamlayan kapanış paragrafları...',
...
IMPORTANT: Generate all output in Turkish.`,
  ...
  'grammar-checker': {
    ...
    metaDescription: 'Ücretsiz AI dilbilgisi denetleyicimizle yazılarınızdaki dilbilgisi hatalarını anında tespit edin ve düzeltin. Yazınızı cilalı ve...',
...
IMPORTANT: Generate all output in Turkish.`,
  ...
  'lorem-ipsum-generator': {
    ...
    metaDescription: 'Tasarım projeleriniz için ücretsiz Lorem Ipsum yer tutucu metni oluşturun. Paragraflar, cümleler veya kelimeler olarak yer tutucu metin...',
    inputLabel: 'Miktar...',
...
IMPORTANT: Generate all output in Turkish.`,
  ...
  'plagiarism-checker': {
    ...
    metaDescription: 'Ücretsiz AI intihal denetleyicimizle yazılarınızda potansiyel intihal tespit edin. İçeriğinizin orijinalliğini değerlendirmeye yardımcı...',
    inputLabel: 'Kontrol edilecek metin...',
...
IMPORTANT: Generate all output in Turkish.`,
  ...
  'content-idea-generator': {
    ...
    metaDescription: 'Ücretsiz AI aracımızla çeşitli formatlar ve platformlar için içerik fikirleri oluşturun. Blog, sosyal medya ve daha fazlası için ilgi...',
...
IMPORTANT: Generate all output in Turkish.`,
  ...
  'website-copy-generator': {
    ...
    metaDescription: 'Ücretsiz AI aracımızla web siteniz için profesyonel ve ikna edici metinler oluşturun. Ana sayfa, hakkımızda ve daha fazlası için içerik...',
...
IMPORTANT: Generate all output in Turkish.`,
  ...
  'resignation-letter-generator': {
    ...
    metaDescription: 'Ücretsiz AI aracımızla profesyonel istifa mektupları dakikalar içinde yazın. İlişkileri koruyan ve itibarınızı koruyan cilalı mektuplar...',
...
IMPORTANT: Generate all output in Turkish.`,
  ...
  'rewording-tool': {
    ...
    metaDescription: 'AI aracımızla metni anında yeniden ifade edin ve yeniden yazın. Netliği artırmak, tonu değiştirmek veya benzersiz içerik oluşturmak için...',
