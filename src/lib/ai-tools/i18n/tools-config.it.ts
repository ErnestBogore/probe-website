...
export const toolsIt: Record<string, ToolConfig> = {
  ...
  'paragraph-generator': {
    ...
    metaDescription: 'Genera paragrafi ben strutturati in pochi secondi con il nostro generatore di paragrafi IA gratuito. Perfetto per post di blog, saggi, email e altro. Nessuna registrazione richiesta.',
...
IMPORTANT: Generate all output in Italian.`,
  ...
  'paragraph-rewriter': {
    ...
    metaDescription: 'Riscrivi paragrafi con il nostro strumento IA gratuito. Migliora la chiarezza, cambia tono o crea variazioni uniche del tuo testo mantenendo il significato originale.',
...
IMPORTANT: Generate all output in Italian.`,
  ...
  'paraphrasing-tool': {
    ...
    metaDescription: 'Parafrasa qualsiasi testo istantaneamente con il nostro strumento IA gratuito. Riformula frasi e paragrafi mantenendo il significato originale. Perfetto per studenti e scrittori.',
...
IMPORTANT: Generate all output in Italian.`,
  ...
  'sentence-rewriter': {
    ...
    metaDescription: 'Riscrivi frasi per chiarezza, impatto o tono migliore. Ottieni variazioni multiple con spiegazioni di ciò che rende ciascuna più forte. Gratuito, senza registrazione.',
...
IMPORTANT: Generate all output in Italian.`,
  ...
  'summarizer': {
    ...
    metaDescription: 'Condensa articoli lunghi, documenti e testi in riassunti chiari e concisi. Il nostro strumento di riepilogo IA gratuito estrae i punti chiave in pochi secondi. Provalo ora.',
...
IMPORTANT: Generate all output in Italian.`,
  ...
  'outline-generator': {
    ...
    metaDescription: 'Genera strutture organizzate per post di blog, saggi e articoli in pochi secondi. Il nostro generatore di strutture IA gratuito ti aiuta a organizzare le idee e scrivere più velocemente.',
...
IMPORTANT: Generate all output in Italian.`,
  ...
  'conclusion-generator': {
    ...
    metaDescription: 'Genera conclusioni convincenti per qualsiasi articolo, saggio o post di blog. Il nostro strumento IA gratuito crea finali soddisfacenti con takeaway chiari e CTA.',
...
IMPORTANT: Generate all output in Italian where applicable.`,
  ...
  'seo-title-generator': {
    ...
    metaDescription: 'Crea titoli ottimizzati per la SEO che migliorano i click-through rate. Il nostro strumento IA gratuito genera meta title perfetti per qualsiasi pagina web in pochi secondi.',
...
IMPORTANT: Generate all output in Italian.`,
  ...
  'meta-description-generator': {
    ...
    metaDescription: 'Crea meta description convincenti che migliorano i click-through rate. Il nostro strumento IA gratuito genera descrizioni ottimizzate per qualsiasi pagina web in pochi secondi.',
    inputLabel: 'Argomento o titolo della pagina...',
    inputPlaceholder: 'es. Migliori scarpe da corsa per principianti nel 2024',
...
IMPORTANT: Generate all output in Italian.`,
  ...
  'content-idea-generator': {
    ...
    metaDescription: 'Genera idee creative per contenuti per blog, YouTube, social media, podcast e newsletter. La nostra IA crea concetti ottimizzati per piattaforma con angoli unici.',
...
IMPORTANT: Generate all output in Italian.`,
  ...
  'video-script-generator': {
    ...
    metaDescription: 'Crea script video coinvolgenti per YouTube, corsi e contenuti aziendali. La nostra IA struttura la tua storia con hook, corpo e CTA. Gratuito e facile.',
...
IMPORTANT: Generate all output in Italian.`,
  ...
  'acronym-generator': {
    ...
    metaDescription: 'Genera acronimi intelligenti e significativi per progetti, prodotti e organizzazioni. Ottieni opzioni multiple con significati espansi. Gratuito e istantaneo.',
...
IMPORTANT: Generate all output in Italian.`,
  ...
  'blog-title-generator': {
    ...
    metaDescription: 'Genera titoli di blog convincenti che guidano i click e si posizionano nella ricerca. La nostra IA crea headline ottimizzate SEO usando trigger psicologici comprovati.',
...
IMPORTANT: Generate all output in Italian.`,
  ...
  'image-alt-text-generator': {
    ...
    metaDescription: 'Genera testo alt descrittivo che migliora accessibilità e SEO. Carica qualsiasi immagine e ottieni descrizioni accessibili ottimizzate per la ricerca.',
...
IMPORTANT: Generate all output in Italian.`,
  ...
  'slogan-generator': {
    ...
    metaDescription: 'Crea slogan memorabili e tagline per il tuo brand, prodotto o campagna. Genera opzioni multiple con diversi angoli creativi. Gratuito e istantaneo.',
...
IMPORTANT: Generate all output in Italian.`,
  ...
  'product-description-generator': {
    ...
    metaDescription: 'Crea descrizioni di prodotto convincenti che convertono i visitatori in acquirenti. Genera copy che evidenzia benefici e guida le vendite. Gratuito per e-commerce.',
...
IMPORTANT: Generate all output in Italian.`,
  ...
  'landing-page-generator': {
    ...
    metaDescription: 'Crea copy di landing page ad alta conversione che trasforma visitatori in clienti. Genera headline, benefici, CTA e altro. Gratuito per marketer.',
...
IMPORTANT: Generate all output in Italian.`,
  ...
  'google-ads-copy-generator': {
    ...
    metaDescription: 'Crea copy Google Ads ad alta conversione che guida click e conversioni. Genera headline, descrizioni e estensioni ottimizzate per RSA. Gratuito per marketer.',
...
IMPORTANT: Generate all output in Italian.`,
  ...
  'resignation-letter-generator': {
    ...
    metaDescription: 'Crea lettere di dimissioni professionali che mantengono le relazioni e proteggono la tua reputazione. Genera lettere formali educate per qualsiasi situazione. Gratuito.',
...
IMPORTANT: Generate all output in Italian.`,
  ...
  'social-media-bio-generator': {
    ...
    metaDescription: 'Crea bio accattivanti per qualsiasi piattaforma social. Genera descrizioni profilo che attirano follower e trasmettono la tua identità unica. Gratuito.',
...
IMPORTANT: Generate all output in Italian.`,
  ...
  'instagram-bio-generator': {
    ...
    metaDescription: 'Crea bio Instagram accattivanti che convertono i visitatori in follower. Genera descrizioni profilo ottimizzate per il limite di 150 caratteri. Gratuito.',
...
IMPORTANT: Generate all output in Italian.`,
  ...
  'instagram-caption-generator': {
    ...
    metaDescription: 'Crea didascalie Instagram coinvolgenti che guidano like, commenti e condivisioni. Genera copy perfetto per qualsiasi post. Gratuito per creator.',
...
IMPORTANT: Generate usernames that work well in Italian TikTok context.`,
  ...
  'youtube-channel-description-generator': {
    ...
    metaDescription: 'Crea descrizioni canale YouTube avvincenti che attirano iscritti. Genera bio ottimizzate per SEO che spiegano il valore del tuo canale. Gratuito.',
...
IMPORTANT: Generate all output in Italian.`,
  ...
  'youtube-name-generator': {
    ...
    metaDescription: 'Crea nomi canale YouTube unici e memorabili che catturano la tua essenza di creator. Genera opzioni brandizzabili per il tuo canale. Gratuito.',
    inputLabel: 'Descrivi il tuo canale YouTube...',
...
IMPORTANT: Generate all output in Italian.`,
  ...
  'rewording-tool': {
    ...
    metaDescription: 'Riformula qualsiasi testo per migliorare chiarezza, cambiare tono o evitare ripetizioni. Ottieni variazioni multiple istantaneamente. Gratuito.',
...
IMPORTANT: Generate all output in Italian.`,
  ...
  'plagiarism-checker': {
    ...
    metaDescription: 'Controlla il tuo contenuto per potenziale plagio e duplicazioni. Assicurati che la tua scrittura sia originale prima della pubblicazione. Gratuito.',
...
## CORE RULES
- Analyze text for patterns suggesting copied content
...
IMPORTANT: Generate all output in Italian.`,
  ...
  'brand-name-generator': {
    ...
    metaDescription: 'Genera nomi di brand unici e memorabili istantaneamente. La nostra IA crea nomi distintivi con significato strategico per la tua identità aziendale.',
...
IMPORTANT: Generate names that work well in Italian business context.`,
  ...
  'product-name-generator': {
    ...
    metaDescription: 'Genera nomi prodotto creativi che vendono. La nostra IA crea nomi memorabili e pronti per il mercato che si distinguono sugli scaffali e nelle menti dei clienti.',
