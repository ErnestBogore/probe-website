...
export const toolsKo: Record<string, ToolConfig> = {
  ...
  'paragraph-generator': {
    ...
    metaDescription: '무료 AI 문단 생성기로 몇 초 만에 잘 구성된 문단을 생성하세요. 블로그 포스트, 에세이, 이메일 등에 완벽합니다. 회원가입 불필요.',
    inputLabel: '주제...',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'paragraph-rewriter': {
    ...
    metaDescription: '무료 AI 도구로 문단을 재작성하세요. 원본 의미를 유지하면서 명확성을 향상하고 톤을 변경하거나 텍스트의 고유한 변형을 만드세요.',
    inputLabel: '재작성할 카피...',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'meta-description-generator': {
    ...
    metaDescription: '클릭률을 높이는 매력적인 메타 설명을 생성합니다. 무료 AI 도구로 몇 초 만에 모든 웹 페이지에 최적화된 설명을 생성하세요.',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'paraphrasing-tool': {
    ...
    metaDescription: '무료 AI 도구로 모든 텍스트를 즉시 패러프레이징하세요. 원본 의미를 유지하면서 문장과 문단을 다시 표현합니다. 학생과 작가에게 완벽합니다.',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'summarizer': {
    ...
    metaDescription: '긴 기사, 문서 및 텍스트를 명확하고 간결한 요약으로 압축합니다. 무료 AI 요약기로 몇 초 만에 핵심 포인트를 추출합니다. 지금 사용해 보세요.',
    inputLabel: '요약할 텍스트...',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'blog-title-generator': {
    ...
    metaDescription: '클릭을 유도하고 검색에서 순위를 매기는 매력적인 블로그 제목을 생성합니다. AI가 검증된 심리적 트리거를 사용하여 SEO 최적화된 헤드라인을 만듭니다.',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'outline-generator': {
    ...
    name: '아웃라인 생성기',
    title: '무료 AI 아웃라인 생성기',
    description: '몇 초 만에 블로그 포스트, 에세이 및 기사를 위한 구조화된 아웃라인을 생성합니다.',
    metaDescription: '몇 초 만에 블로그 포스트, 에세이 및 기사를 위한 구조화된 아웃라인을 생성합니다. 무료 AI 아웃라인 생성기는 아이디어를 정리하고 더 빨리 작성하도록 도와줍니다.',
    inputLabel: '주제 또는 제목...',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'ai-content-detector': {
    ...
    metaDescription: '무료 도구로 AI 생성 콘텐츠를 즉시 감지합니다. 상세한 분석을 받고 텍스트가 AI처럼 들리게 하는 요소를 알아보세요. 회원가입 불필요.',
    inputLabel: '분석할 텍스트...',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'ai-text-humanizer': {
    ...
    metaDescription: 'AI 생성 텍스트를 자연스럽고 인간적인 글쓰기로 변환합니다. 무료 휴머나이저는 원본 의미를 유지하면서 로봇 같은 패턴을 제거합니다.',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'conclusion-generator': {
    ...
    metaDescription: '모든 기사, 에세이 또는 블로그 포스트를 위한 매력적인 결론을 생성합니다. 무료 AI 도구는 명확한 요점과 CTA가 있는 만족스러운 마무리를 만듭니다.',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'grammar-checker': {
    ...
    metaDescription: '무료로 문법, 맞춤법, 구두점을 확인합니다. 명확한 설명과 함께 즉각적인 수정 사항을 받아 글쓰기 실력을 향상시키세요.',
    inputLabel: '확인할 텍스트...',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'sentence-rewriter': {
    ...
    metaDescription: '명확성, 임팩트 또는 더 나은 톤을 위해 문장을 재작성합니다. 각각을 더 강하게 만드는 이유에 대한 설명과 함께 여러 변형을 받으세요. 무료, 회원가입 불필요.',
    inputLabel: '재작성할 문장...',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'acronym-generator': {
    ...
    name: '두문자어 생성기',
    title: '무료 AI 두문자어 생성기',
    description: '프로젝트, 제품 및 조직을 위한 영리하고 의미 있는 두문자어를 생성합니다.',
    metaDescription: '프로젝트, 제품 및 조직을 위한 영리하고 의미 있는 두문자어를 생성합니다. 확장된 의미와 함께 여러 옵션을 받으세요. 무료이며 즉각적입니다.',
    inputLabel: '주제 또는 개념...',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'lorem-ipsum-generator': {
    ...
    metaDescription: '디자인, 목업 및 레이아웃을 위한 로렘 입숨 자리 표시자 텍스트를 생성합니다. 전통적이거나 현대적인 대안을 선택하세요. 복사-붙여넣기 준비 완료.',
    inputLabel: '필요한 양...',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'emoji-translator': {
    ...
    metaDescription: '텍스트를 표현력 풍부한 이모지로 번역하거나 이모지 메시지를 해독합니다. 소셜 미디어, 메시징 및 재미있는 커뮤니케이션에 완벽합니다. 무료로 사용하세요.',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'plagiarism-checker': {
    ...
    metaDescription: '콘텐츠의 독창성을 분석하고 인용이나 재작성이 필요할 수 있는 구절을 식별합니다. 글쓰기를 개선하기 위한 실행 가능한 피드백을 받으세요.',
    inputLabel: '확인할 텍스트...',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'blog-post-ideas-generator': {
    ...
    metaDescription: '콘텐츠 아이디어가 고민이신가요? 몇 초 만에 고유하고 SEO 최적화된 블로그 포스트 아이디어를 생성하세요. AI가 작성 준비가 된 주제를 제공합니다.',
    inputLabel: '주제 또는 니치...',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'seo-title-generator': {
    ...
    metaDescription: '더 높은 순위를 매기고 더 많은 클릭을 얻는 검색 최적화 제목 태그를 생성합니다. AI가 올바른 위치에 키워드가 있는 완벽한 크기의 제목을 만듭니다.',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'image-alt-text-generator': {
    ...
    metaDescription: '접근성과 SEO를 개선하는 설명적인 대체 텍스트를 생성합니다. 모든 이미지를 업로드하고 검색에 최적화된 스크린 리더 친화적인 설명을 받으세요.',
    inputLabel: '이미지 설명...',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'content-idea-generator': {
    ...
    metaDescription: '블로그, YouTube, 소셜 미디어, 팟캐스트 및 뉴스레터를 위한 창의적인 콘텐츠 아이디어를 생성합니다. AI가 고유한 앵글을 가진 플랫폼 최적화 개념을 만듭니다.',
    inputLabel: '주제 또는 니치...',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'video-script-generator': {
    ...
    metaDescription: 'YouTube, TikTok, Reels 등을 위한 매력적인 비디오 스크립트를 생성합니다. AI가 후크, 시각 큐 및 CTA가 포함된 리텐션 최적화 스크립트를 만듭니다.',
    inputLabel: '비디오 주제...',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'brand-name-generator': {
    ...
    name: '브랜드명 생성기',
    title: '무료 AI 브랜드명 생성기',
    description: '독특하고 기억에 남는 브랜드명을 즉시 생성합니다. AI가 비즈니스 정체성을 위한 전략적 의미를 가진 독특한 이름을 만듭니다.',
    metaDescription: '독특하고 기억에 남는 브랜드명을 즉시 생성합니다. AI가 비즈니스 정체성을 위한 전략적 의미를 가진 독특한 이름을 만듭니다.',
    inputLabel: '브랜드 설명...',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'business-name-generator': {
    ...
    metaDescription: '실제 세계에서 작동하는 창의적인 비즈니스 이름을 생성합니다. AI가 모든 산업을 위한 전문적이고 기억에 남는 이름을 만듭니다.',
    inputLabel: '비즈니스 설명...',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'product-name-generator': {
    ...
    metaDescription: '판매하는 창의적인 제품명을 생성합니다. AI가 진열대와 고객 마음에 눈에 띄는 기억에 남고 시장에 출시 가능한 이름을 만듭니다.',
    inputLabel: '제품 설명...',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'slogan-generator': {
    ...
    metaDescription: '브랜드의 본질을 포착하는 캐치하고 기억에 남는 슬로건을 만드세요. AI가 고객 마음에 남는 태그라인을 생성합니다.',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'google-ads-copy-generator': {
    ...
    metaDescription: '클릭과 전환을 유도하는 고전환 Google 광고 카피를 생성합니다. AI가 성과에 최적화된 헤드라인과 설명을 만듭니다.',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'product-description-generator': {
    ...
    metaDescription: '판매하는 매력적인 제품 설명을 생성합니다. AI가 이커머스, 마켓플레이스 및 카탈로그를 위한 혜택 중심 카피를 만듭니다.',
    inputLabel: '제품 설명...',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'landing-page-generator': {
    ...
    metaDescription: '전환하는 완전한 랜딩 페이지 카피를 생성합니다. AI가 오퍼를 위한 헤드라인, 기능, 추천, FAQ 및 CTA를 만듭니다.',
    inputLabel: '제품/서비스 및 오퍼 설명...',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'website-copy-generator': {
    ...
    metaDescription: '몇 분 만에 전문적인 웹사이트 콘텐츠를 생성합니다. AI가 홈페이지, 소개 페이지, 서비스 페이지 등을 위한 카피를 만듭니다.',
    inputLabel: '비즈니스 설명...',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'resignation-letter-generator': {
    ...
    metaDescription: '관계를 유지하면서 전문적인 퇴직서를 작성합니다. AI가 모든 상황에 맞는 퇴직 통보서를 만듭니다.',
    inputLabel: '상황 설명...',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'hook-generator': {
    ...
    metaDescription: '콘텐츠를 위한 주목을 끄는 훅을 즉시 생성하세요. AI가 독자를 사로잡고 참여도를 높이는 매력적인 첫 문장을 생성합니다.',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'social-media-bio-generator': {
    ...
    metaDescription: '소셜 미디어 프로필을 위한 완벽한 바이오를 즉시 생성하세요. AI가 개인 브랜드를 보여주고 팔로워를 유치하는 매력적이고 전문적인 바이오를 만듭니다.',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'instagram-bio-generator': {
    ...
    metaDescription: '몇 초 만에 완벽한 인스타그램 바이오를 만드세요. AI가 팔로워를 유치하고 개인 브랜드를 보여주는 매력적이고 개성 넘치는 바이오를 생성합니다.',
    inputLabel: '자신 또는 브랜드를 설명하세요...',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'social-media-caption-generator': {
    ...
    metaDescription: '좋아요, 댓글, 공유를 유도하는 매력적인 소셜 미디어 캡션을 생성하세요. AI가 인스타그램, 페이스북, 트위터 등을 위한 매력적인 포스트 카피를 만듭니다.',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'instagram-caption-generator': {
    ...
    metaDescription: '스크롤을 멈추게 하는 인스타그램 캡션을 즉시 생성하세요. AI가 좋아요, 댓글, 저장을 높이는 릴스, 캐러셀, 피드 포스트용 매력적인 캡션을 생성합니다.',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'social-media-hashtag-generator': {
    ...
    metaDescription: '도달 범위와 참여도를 높이는 효과적인 해시태그를 생성하세요. AI가 인스타그램, 틱톡, 트위터 등을 위한 전략적인 해시태그 세트를 만듭니다.',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'instagram-hashtag-generator': {
    ...
    metaDescription: '도달 범위와 참여도를 높이는 완벽한 인스타그램 해시태그를 생성하세요. AI가 콘텐츠와 니치에 맞춤화된 전략적인 해시태그 세트를 만듭니다.',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'social-media-username-generator': {
    ...
    metaDescription: '소셜 미디어 프로필을 위한 고유하고 기억에 남는 사용자명을 생성하세요. AI가 인스타그램, 틱톡, 트위터 등에서 작동하는 개인화된 사용자명 아이디어를 만듭니다.',
    inputLabel: '자신 또는 브랜드를 설명하세요...',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'instagram-name-generator': {
    ...
    metaDescription: '돋보이는 고유한 인스타그램 사용자명을 생성하세요. AI가 존재감을 구축하고 발견되도록 돕는 기억에 남는 온브랜드 핸들을 만듭니다.',
    inputLabel: '자신 또는 브랜드를 설명하세요...',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'tiktok-hashtag-generator': {
    ...
    metaDescription: '가시성을 높이는 트렌드 틱톡 해시태그를 생성하세요. AI가 비디오가 For You 페이지에 도달하도록 돕는 전략적인 해시태그 조합을 만듭니다.',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'tiktok-username-generator': {
    ...
    metaDescription: '분위기에 맞는 고유한 틱톡 사용자명을 생성하세요. AI가 돋보이고 팔로워를 늘리는 데 도움이 되는 기억에 남는 온트렌드 핸들을 만듭니다.',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'youtube-channel-description-generator': {
    ...
    metaDescription: '구독자를 유치하는 매력적인 유튜브 채널 설명을 만드세요. AI가 콘텐츠를 보여주고 청중을 늘리는 SEO 최적화된 설명을 생성합니다.',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'youtube-name-generator': {
    ...
    metaDescription: '돋보이는 창의적인 유튜브 채널 이름을 생성하세요. AI가 구독자를 유치하고 콘텐츠 니치를 반영하는 기억에 남고 브랜드화 가능한 이름을 만듭니다.',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'youtube-video-description-generator': {
    ...
    metaDescription: '조회수를 높이는 SEO 최적화된 유튜브 설명을 생성하세요. AI가 비디오가 더 높은 순위를 차지하도록 돕는 훅, 타임스탬프, 키워드가 포함된 매력적인 설명을 만듭니다.',
...
IMPORTANT: Generate all output in Korean.`,
  ...
  'rewording-tool': {
    ...
    metaDescription: 'AI 도구로 텍스트를 즉시 다시 말하고 바꿔 표현하세요. 명확성을 높이고, 톤을 변경하거나, 고유한 콘텐츠를 만들기 위해 문장과 단락을 변환합니다.',
