...
'aesthetic': {
  ...
  metaDescription: 'AI 기반 생성기로 에스테틱 비즈니스를 위한 매력적인 이름을 찾아보세요. 메디스파, 클리닉, 뷰티 클리닉을 위한 우아하고 세련된 이름을 만들어 보세요. 무료이며 사용하기 쉽습니다!',
...
'agency': {
  ...
  metaDescription: '무료 AI 생성기로 멋진 이름과 함께 에이전시를 시작하세요. 마케팅, 크리에이티브, 디지털, 컨설팅 에이전시를 위한 전문적이고 신뢰할 수 있는 이름을 만드세요. 간편하고 맞춤형입니다!',
...
'app': {
  ...
  metaDescription: 'AI 기반 생성기로 앱에 완벽한 이름을 만드세요. 앱 스토어에서 눈에 띄고 사용자에게 공감을 주는 명확하고 기억에 남는 앱 이름을 생성하세요. 무료이며 사용하기 쉽습니다!',
...
'babysitting': {
  ...
  metaDescription: 'AI 기반 생성기로 베이비시팅 비즈니스에 완벽한 이름을 찾으세요. 부모를 안심시키고 보육 브랜드를 구축하는 신뢰할 수 있고 따뜻한 이름을 만드세요. 빠르고, 무료이며, 감동을 줍니다!',
...
'beauty': {
  ...
  metaDescription: 'AI 기반 생성기로 뷰티 비즈니스를 위한 매력적인 이름을 만드세요. 살롱, 스튜디오, 화장품 브랜드를 위한 화려하고 세련된 이름을 생성하세요. 무료이며 매력적입니다!',
...
'boutique': {
  ...
  metaDescription: 'AI 기반 생성기로 시크한 부티크 이름을 찾아보세요. 패션샵, 선물 가게, 스페셜티 리테일을 위한 독특하고 스타일리시한 이름을 만들어 보세요. 빠르고 무료이며 인상적입니다!',
...
'cafe': {
  ...
  metaDescription: '번거로움 없이 완벽한 카페 이름을 얻으세요. AI 도구가 커피숍, 베이커리 카페, 브런치 장소를 위한 독특하고 환영하는 이름을 만들어 드립니다. 무료이며 성공을 위해 설계되었습니다!',
...
'cake': {
  ...
  metaDescription: '무료 AI 생성기로 환상적인 케이크 비즈니스 이름을 만들어 보세요. 베이커리, 웨딩 케이크 디자이너, 축하 케이크 메이커를 위한 유혹적이고 기억에 남는 이름을 만들어 드립니다. 빠르고 재미있으며 완전 무료입니다!',
...
'candle': {
  ...
  metaDescription: '완벽한 이름으로 캔들 비즈니스를 빛나게 하세요. AI 생성기가 캔들 메이커와 홈 프래그런스 브랜드를 위한 창의성을 불러일으킵니다. 무료이며 브랜드를 빛나게 하도록 설계되었습니다!',
...
'candy': {
  ...
  metaDescription: 'AI로 생성된 캔디 비즈니스 이름으로 달콤한 갈망을 충족하세요. 캔디샵, 과자점, 달콤한 간식 브랜드를 위한 달콤하고 장난스러운 이름을 만들어 드립니다. 빠르고 무료이며 성공을 위해 설계되었습니다!',
...
'clothing-store': {
  ...
  metaDescription: 'AI 기반 도구로 트렌디한 의류 사업 이름을 손쉽게 생성하세요. 의류 매장, 패션 부티크, 소매점을 위한 스타일리시하고 기억에 남는 이름을 만드세요. 무료로 간편하게 사용 가능!',
...
'cookie': {
  ...
  metaDescription: '무료 AI 생성기로 맛있는 쿠키 사업 이름을 만드세요. 베이커리, 쿠키 샵, 달콤한 간식 사업을 위한 군침 도는 기억에 남는 이름을 만들어 보세요. 빠르고 재미있고 간편합니다!',
...
'cosmetic': {
  ...
  metaDescription: 'AI 생성기로 화장품 사업에 완벽한 이름을 얻으세요. 메이크업 브랜드, 스킨케어 라인, 뷰티 제품을 위한 우아하고 세련된 이름을 만드세요. 빠르고 무료이며 맞춤화됩니다!',
...
'craft-store': {
  ...
  metaDescription: 'AI 기반 생성기로 매장에 완벽한 이름을 만드세요. 미술 용품점, 공예품 매장, 창작 사업을 위한 상상력 넘치고 영감을 주는 이름을 만드세요. 무료로 간편하게 사용 가능!',
...
'crochet': {
  ...
  metaDescription: 'AI 생성기로 독특한 코바늘 사업 이름을 함께 뜨세요. 실 가게, 수제 제품, 섬유 예술 사업을 위한 매력적이고 기억에 남는 이름을 만드세요. 빠르고 무료이며 창의적입니다!',
...
'dessert': {
  ...
  metaDescription: '무료 AI 생성기로 디저트 사업에 완벽한 이름을 달콤하게 만드세요. 베이커리, 파티세리, 스위트 샵을 위한 군침 도는 기억에 남는 이름을 만드세요. 지금 시도해 보세요!',
...
'digital-marketing': {
  ...
  metaDescription: 'AI 생성 이름으로 디지털 마케팅 벤처를 강화하세요. 마케팅 에이전시, SEO 회사, 광고 사업을 위한 전문적이고 혁신적인 이름을 만드세요. 빠르고 무료이며 맞춤화됩니다!',
...
'electronics': {
  ...
  metaDescription: '무료 AI 생성기로 전자제품 사업에 완벽한 이름을 전기화하세요. 테크 스토어, 가젯 샵, 기기 소매업체를 위한 혁신적이고 신뢰할 수 있는 이름을 만드세요. 지금 시도해 보세요!',
...
'event': {
  ...
  metaDescription: '무료 AI 생성기로 이벤트 사업에 완벽한 이름을 계획하세요. 웨딩 플래너, 파티 코디네이터, 축하 회사를 위한 기억에 남고 창의적인 이름을 만드세요. 빠르고 간편합니다!',
...
'fashion-store': {
  ...
  metaDescription: '창의적인 이름으로 패션 매장을 올바르게 시작하세요. 부티크, 의류 매장, 패션 소매업체를 위한 스타일리시하고 기억에 남는 이름을 무료 AI 생성기로 만드세요!',
...
'fitness': {
  ...
  metaDescription: 'AI 생성 이름으로 피트니스 비즈니스를 형성하세요. 헬스장, 스튜디오, 개인 트레이닝 비즈니스를 위한 동기 부여적이고 에너지 넘치는 이름을 만드세요. 빠르고, 무료이며, 성공을 위해 설계되었습니다!',
...
'flower-shop': {
  ...
  metaDescription: '무료 AI 생성기의 완벽한 이름으로 꽃집 비즈니스에 꽃을 피우세요. 플로리스트, 꽃 스튜디오, 꽃 배달 서비스를 위한 매력적이고 기억에 남는 이름을 만드세요. 지금 사용해보세요!',
...
'food': {
  ...
  metaDescription: '더 이상 음식 사업 이름으로 고민하지 마세요! AI 생성기가 레스토랑, 식품 브랜드, 요리 비즈니스를 위한 훌륭한 이름을 제공합니다. 무료이고, 식욕을 돋우고, 기억에 남습니다. 지금 사용해보세요!',
...
'food-truck': {
  ...
  metaDescription: '푸드트럭 비즈니스를 위한 완벽한 이름으로 도로에 나서세요. 무료 AI 생성기로 모바일 음식 판매업체를 위한 인상적이고 기억에 남는 이름을 만드세요. 빠르고, 식욕을 돋우고, 무료입니다!',
...
'funny': {
  ...
  metaDescription: 'AI 생성 재미있는 비즈니스 이름으로 브랜드에 유머를 더하세요. 엔터테인먼트 비즈니스와 펀 브랜드를 위한 재치 있고, 영리하고, 웃음을 유발하는 이름을 만드세요. 빠르고, 무료이며, 창의적입니다!',
...
'furniture-store': {
  ...
  metaDescription: '무료 AI 생성기의 훌륭한 이름으로 가구 매장을 꾸미세요. 가구 매장, 홈 데코 샵, 인테리어 비즈니스를 위한 우아하고 초대하는 이름을 만드세요. 손쉽고 맞춤 제작됩니다!',
...
'game': {
  ...
  metaDescription: 'AI 생성 이름으로 게임 비즈니스를 레벨업하세요. 게임 스튜디오, 게이밍 회사, 인터랙티브 엔터테인먼트를 위한 매력적이고 기억에 남는 이름을 만드세요. 빠르고, 무료이며, 맞춤 제작됩니다!',
...
'graphic-design': {
  ...
  metaDescription: '매력적인 그래픽 디자인 사업 이름으로 성공을 디자인하세요. 디자인 스튜디오, 에이전시, 프리랜서를 위한 창의적이고 전문적인 이름을 만드세요. AI 도구가 무료로 해드립니다!',
...
'hair': {
  ...
  metaDescription: '더 이상 헤어 사업 이름으로 고민하지 마세요! AI 생성기가 살롱, 스타일리스트, 헤어 제품 비즈니스를 위한 독특하고 스타일리시한 이름을 제작합니다. 무료이고, 창의적이고, 기억에 남습니다!',
...
'health': {
  ...
  metaDescription: '무료 AI 생성기의 완벽한 이름으로 건강 비즈니스에 활력을 불어넣으세요. 웰니스 센터, 헬스 프랙티스, 헬스케어 서비스를 위한 신뢰할 수 있고 자비로운 이름을 만드세요. 지금 사용해보세요!',
...
'ice-cream': {
  ...
  metaDescription: '무료 AI 아이스크림 사업 이름 생성기로 창의적이고 달콤한 사업 이름을 만드세요. 아이스크림 숍, 젤라토 가게, 프로즌 요거트 비즈니스를 위한 완벽한 이름을 찾으세요.',
...
'interior-design': {
  ...
  metaDescription: '무료 AI 인테리어 사업 이름 생성기로 전문적이고 창의적인 사업 이름을 만드세요. 인테리어 디자인 스튜디오, 홈 스테이징, 리모델링 비즈니스를 위한 완벽한 이름을 찾으세요.',
...
'it': {
  ...
  metaDescription: '무료 AI IT 사업 이름 생성기로 혁신적이고 전문적인 사업 이름을 만드세요. IT 서비스, 소프트웨어 개발, 클라우드 솔루션 비즈니스를 위한 완벽한 이름을 찾으세요.',
  buttonText: 'IT 이름 생성',
...
'jewelry-store': {
  ...
  metaDescription: '무료 AI 주얼리 사업 이름 생성기로 우아하고 럭셔리한 사업 이름을 만드세요. 보석 가게, 주얼리 디자인 스튜디오, 액세서리 브랜드를 위한 완벽한 이름을 찾으세요.',
...
'lip-gloss': {
  ...
  metaDescription: '무료 AI 립글로스 사업 이름 생성기로 매력적이고 기억에 남는 사업 이름을 만드세요. 립글로스 브랜드, 립 코스메틱, 뷰티 비즈니스를 위한 완벽한 이름을 찾으세요.',
...
'marketing': {
  ...
  metaDescription: '무료 AI 마케팅 사업 이름 생성기로 창의적이고 기억에 남는 사업 이름을 만드세요. 마케팅 에이전시, 디지털 마케팅, 브랜드 컨설팅 비즈니스를 위한 완벽한 이름을 찾으세요.',
...
'music': {
  ...
  metaDescription: '무료 AI 음악 사업 이름 생성기로 감성적이고 기억에 남는 사업 이름을 만드세요. 음악 스튜디오, 레코드 레이블, 음악 학원 비즈니스를 위한 완벽한 이름을 찾으세요.',
  buttonText: '음악 이름 생성',
...
'perfume': {
  ...
  metaDescription: '무료 AI 향수 사업 이름 생성기로 매혹적이고 기억에 남는 사업 이름을 만드세요. 향수 브랜드, 프래그런스 하우스, 아로마 비즈니스를 위한 완벽한 이름을 찾으세요.',
  buttonText: '향수 이름 생성',
...
'photography': {
  ...
  metaDescription: '무료 AI 사진 사업 이름 생성기로 예술적이고 기억에 남는 사업 이름을 만드세요. 사진 스튜디오, 웨딩 포토그래피, 상업 촬영 비즈니스를 위한 완벽한 이름을 찾으세요.',
  buttonText: '사진 이름 생성',
...
'print-shop': {
  ...
  metaDescription: '무료 AI 인쇄소 사업 이름 생성기로 전문적이고 신뢰할 수 있는 사업 이름을 만드세요. 인쇄소, 복사점, 대형 출력 비즈니스를 위한 완벽한 이름을 찾으세요.',
...
'real-estate': {
  ...
  metaDescription: '무료 AI 부동산 사업 이름 생성기로 전문적이고 기억에 남는 사업 이름을 만드세요. 부동산 중개, 개발, 투자 비즈니스를 위한 완벽한 이름을 찾으세요.',
...
'shoes': {
  ...
  metaDescription: '무료 AI 신발 사업 이름 생성기로 트렌디하고 매력적인 사업 이름을 만드세요. 신발 브랜드, 슈즈 스토어, 커스텀 슈즈 비즈니스를 위한 완벽한 이름을 찾으세요.',
  buttonText: '신발 이름 생성',
...
'skin-care': {
  ...
  metaDescription: '무료 AI 스킨케어 사업 이름 생성기로 순수하고 효과적인 사업 이름을 만드세요. 스킨케어 브랜드, 에스테틱, 뷰티 비즈니스를 위한 완벽한 이름을 찾으세요.',
...
'slime': {
  ...
  metaDescription: '무료 AI 슬라임 사업 이름 생성기로 재미있고 기억에 남는 사업 이름을 만드세요. 슬라임 숍, ASMR 슬라임, DIY 슬라임 비즈니스를 위한 완벽한 이름을 찾으세요.',
...
'soap': {
  ...
  metaDescription: '무료 AI 비누 사업 이름 생성기로 자연스럽고 기억에 남는 사업 이름을 만드세요. 핸드메이드 비누, 천연 비누, 아로마 비누 비즈니스를 위한 완벽한 이름을 찾으세요.',
  buttonText: '비누 이름 생성',
...
'sportswear': {
  ...
  metaDescription: '무료 AI 스포츠웨어 사업 이름 생성기로 역동적이고 영감을 주는 사업 이름을 만드세요. 운동복, 애슬레저, 스포츠 의류 브랜드를 위한 완벽한 이름을 찾으세요.',
...
't-shirt': {
  ...
  metaDescription: '무료 AI 티셔츠 사업 이름 생성기로 트렌디하고 개성 있는 사업 이름을 만드세요. 커스텀 티셔츠, 그래픽 티, 의류 브랜드를 위한 완벽한 이름을 찾으세요.',
...
'tea': {
  ...
  metaDescription: '무료 AI 차 사업 이름 생성기로 세련되고 독특한 사업 이름을 만드세요. 전통차, 블렌딩 티, 티 카페 비즈니스를 위한 완벽한 이름을 찾으세요.',
  buttonText: '차 이름 생성',
...
'tech': {
  ...
  metaDescription: '무료 AI 테크 사업 이름 생성기로 미래지향적이고 혁신적인 사업 이름을 만드세요. 소프트웨어, 하드웨어, IT 서비스 비즈니스를 위한 완벽한 이름을 찾으세요.',
  buttonText: '테크 이름 생성',
...
'travel': {
  ...
  metaDescription: '무료 AI 여행 사업 이름 생성기로 영감을 주고 신뢰할 수 있는 사업 이름을 만드세요. 여행사, 투어 회사, 여행 블로그를 위한 완벽한 이름을 찾으세요.',
  buttonText: '여행 이름 생성',
...
export function getBusinessNameGeneratorKo(slug: string): BusinessNameGeneratorConfig | undefined {
  return businessNameGeneratorsKo[slug];
}
