...
export const businessNameGeneratorsZh: Record<string, BusinessNameGeneratorConfig> = {
  ...
  'aesthetic': {
    ...
    metaDescription: '使用我们的AI驱动生成器，为您的美学企业发现一个迷人的名称。为医疗美容院、诊所和美容机构创建优雅、精致的名称。免费且易于使用！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
    inputLabel: '描述您的美学企业...',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'agency': {
    ...
    metaDescription: '使用我们的免费AI生成器，为您的代理企业起一个出色的名称。为营销、创意、数字和咨询机构创建专业、值得信赖的名称。简单且量身定制！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
    inputLabel: '描述您的代理企业...',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'app': {
    ...
    metaDescription: '使用我们的AI驱动生成器，为您的应用创建完美的名称。生成清晰、令人难忘的应用名称，在应用商店中脱颖而出并与用户产生共鸣。免费且易于使用！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'babysitting': {
    ...
    metaDescription: '使用我们的AI驱动生成器，为您的保姆企业找到完美的名称。创建让家长安心、建立育儿品牌的值得信赖、充满关爱的名称。快速、免费，一定能给人留下深刻印象！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
    inputLabel: '描述您的保姆企业...',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'beauty': {
    ...
    metaDescription: '使用我们的AI驱动生成器，为您的美容企业创建一个迷人的名称。为沙龙、工作室和化妆品品牌生成迷人、精致的名称。免费且令人着迷！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
    inputLabel: '描述您的美容企业...',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'boutique': {
    ...
    metaDescription: '为您的精品店、特色商店或策划购物体验生成独特的企业名称。使用 AI 驱动的名称生成器为您的零售品牌创建完美的名称。 立即在Analyze AI上免费试用此工具及更多免费工具。',
...
- Ensure names work across multiple languages and cultures when applicable`,
  ...
  'cafe': {
    ...
    metaDescription: '为您的咖啡馆、咖啡店或茶馆生成独特的企业名称。使用 AI 驱动的名称生成器为您的咖啡馆品牌创建完美的名称。 立即在Analyze AI上免费试用此工具及更多免费工具。',
...
- Ensure names work in local and potentially international markets`,
  ...
  'cake': {
    ...
    metaDescription: '为您的蛋糕店、面包店或定制蛋糕业务生成独特的企业名称。使用 AI 驱动的名称生成器为您的烘焙品牌创建完美的名称。 立即在Analyze AI上免费试用此工具及更多免费工具。',
    inputLabel: '描述您的蛋糕业务',
...
- Ensure names work in local and potentially international markets`,
  ...
  'candle': {
    ...
    metaDescription: '为您的蜡烛公司、芬香企业或工匠蜡烛业务生成独特的企业名称。使用 AI 驱动的名称生成器为您的蜡烛品牌创建完美的名称。 立即在Analyze AI上免费试用此工具及更多免费工具。',
    inputLabel: '描述您的蜡烛业务',
...
- Ensure names work in local and potentially international markets`,
  ...
  'candy': {
    ...
    metaDescription: '为您的糖果公司、甜品店或糖果制造业务生成独特的企业名称。使用 AI 驱动的名称生成器为您的糖果品牌创建完美的名称。 立即在Analyze AI上免费试用此工具及更多免费工具。',
    inputLabel: '描述您的糖果业务',
...
- Ensure names work in local and potentially international markets`,
  ...
  'clothing-store': {
    ...
    metaDescription: '为您的服装店生成创意、难忘的企业名称。使用 AI 动力的工具探索适合您的零售时尚品牌的数百个独特选项。 立即在Analyze AI上免费试用此工具及更多免费工具。',
...
Ensure names are professional, marketable, and suitable for a fashion retail business.`,
  ...
  'cookie': {
    ...
    metaDescription: '为您的饼干业务生成创意、美味的企业名称。探索数百个独特的 AI 生成的名称选项，适合您的烘焙品牌。 立即在Analyze AI上免费试用此工具及更多免费工具。',
...
Ensure names are warm, inviting, and suitable for a food and bakery business.`,
  ...
  'cosmetic': {
    ...
    metaDescription: '为您的化妆品品牌生成创意、优雅的企业名称。探索数百个独特的 AI 生成名称，适合您的美容品牌。 立即在Analyze AI上免费试用此工具及更多免费工具。',
...
Ensure names are sophisticated, marketable, and suitable for a beauty and cosmetics company.`,
  ...
  'craft-store': {
    ...
    metaDescription: '为您的手工艺品店生成创意、鼓舞人心的企业名称。探索数百个独特的 AI 生成的选项，适合您的创意零售品牌。 立即在Analyze AI上免费试用此工具及更多免费工具。',
...
Ensure names are inspiring, accessible, and suitable for a craft retail business.`,
  ...
  'crochet': {
    ...
    metaDescription: '为您的钩针编织业务生成创意、舒适的企业名称。探索数百个独特的 AI 生成的选项，适合您的纤维艺术品牌。 立即在Analyze AI上免费试用此工具及更多免费工具。',
...
Ensure names are warm, engaging, and suitable for a crochet and fiber arts business.`,
  ...
  'dessert': {
    ...
    metaDescription: '为您的甜点企业、甜品店或糕点店生成创意品牌名称。使用我们的免费 AI 甜点名称生成器创建令人垂涎、记忆深刻的甜品业务名称。 立即在Analyze AI上免费试用此工具及更多免费工具。',
    inputLabel: '描述您的甜点企业...',
...
- Versatile across dessert types`,
  ...
  'digital-marketing': {
    ...
    metaDescription: '为您的数字营销机构、代理公司或营销咨询公司生成创意品牌名称。使用我们的免费 AI 数字营销名称生成器创建专业、令人信赖的营销业务名称。 立即在Analyze AI上免费试用此工具及更多免费工具。',
...
- Memorable and unique in the industry`,
  ...
  'electronics': {
    ...
    metaDescription: '为您的电子零售店、科技商店或电子产品公司生成创意品牌名称。使用我们的免费 AI 电子产品名称生成器创建创新、专业的电子产品业务名称。 立即在Analyze AI上免费试用此工具及更多免费工具。',
...
- Memorable and unique in the industry`,
  ...
  'event': {
    ...
    metaDescription: '为您的活动策划公司、活动执行或活动制作公司生成创意品牌名称。使用我们的免费 AI 活动名称生成器创建专业、令人难忘的活动业务名称。 立即在Analyze AI上免费试用此工具及更多免费工具。',
    inputLabel: '描述您的活动企业...',
...
- Evocative of special moments and celebrations`,
  ...
  'fashion-store': {
    ...
    metaDescription: '为您的时尚店、服装店或时尚买手店生成创意品牌名称。使用我们的免费 AI 时尚名称生成器创建时尚、令人信赖的服装店名称。 立即在Analyze AI上免费试用此工具及更多免费工具。',
    inputLabel: '描述您的时尚企业...',
...
- Memorable and unique in the industry`,
  ...
  'fitness': {
    ...
    metaDescription: '使用我们的AI驱动生成器，为您的健身企业发现一个充满活力的名称。为健身房、个人训练和在线健身项目创建激励性、令人难忘的名称。免费且易于使用！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
    inputLabel: '描述您的健身企业...',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'flower-shop': {
    ...
    metaDescription: '使用我们的AI驱动生成器，为您的花店发现一个迷人的名称。为花卉设计、花束和礼品企业创建浪漫、优雅的名称。免费且易于使用！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
    inputLabel: '描述您的花店...',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'food': {
    ...
    metaDescription: '使用我们的AI驱动生成器，为您的餐饮企业发现一个诱人的名称。为餐厅、咖啡馆和烹饪企业创建美味、令人难忘的名称。免费且易于使用！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
    inputLabel: '描述您的食品业务...',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'food-truck': {
    ...
    metaDescription: '使用我们的AI驱动生成器，为您的食品卡车发现一个引人注目的名称。为移动食品和街头美食企业创建朗朗上口、令人难忘的名称。免费且易于使用！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
    inputLabel: '描述您的食品卡车...',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'funny': {
    ...
    metaDescription: '使用我们的AI驱动生成器，为您的幽默企业发现一个聪慧的名称。为喜剧企业、趣味品牌和有趣的业务创建俏皮、令人难忘的名称。免费且易于使用！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
    inputLabel: '描述您的幽默企业...',
...
IMPORTANT: Generate all output in Chinese.`,
  ...
  'furniture-store': {
    ...
    metaDescription: '用我们的免费人工智能生成器为您的家具店创意命名。为家具店、家居装饰店和室内家居企业创建优雅而温馨的名称。轻松又量身定制！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
    inputLabel: '描述您的家具店...',
...
- Versatile across furniture types`,
  ...
  'game': {
    ...
    metaDescription: '用人工智能生成的名称为您的游戏事业升级。为游戏工作室、游戏公司和互动娱乐创建引人注目、难忘的名称。快速、免费且量身定制！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
    inputLabel: '描述您的游戏企业...',
...
- Versatile across game genres`,
  ...
  'graphic-design': {
    ...
    metaDescription: '用吸引人的平面设计企业名称设计您的成功。为设计工作室、代理公司和自由职业设计师创建创意、专业的名称。我们的人工智能工具免费提供！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
...
- Versatile across design services`,
  ...
  'hair': {
    ...
    metaDescription: '不再有令人头疼的企业名称！我们的人工智能生成器为沙龙、发型师和头发产品业务创造独特时尚的名称。免费、创意且难忘！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
    inputLabel: '描述您的美发企业...',
...
- Versatile across hair services`,
  ...
  'health': {
    ...
    metaDescription: '用完美的名称激励您的健康企业——从我们的免费人工智能生成器。为健康中心、医疗实践和医疗服务创建可信富有同情心的名称。现在试试！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
    inputLabel: '描述您的健康企业...',
...
- Versatile across health services`,
  ...
  'ice-cream': {
    ...
    metaDescription: '使用我们的免费 AI 生成器为您的冰淇淋店创建完美名称。生成顾客渴望的甜蜜、难忘的名字！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
...
5. Ensure appropriate for family-friendly business`,
  ...
  'interior-design': {
    ...
    metaDescription: '使用我们的人工智能工具轻松创建令人惊艳的室内设计企业名称。无需成本，无需麻烦，只需创意！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
...
5. Ensure appropriate for professional B2C/B2B services`,
  ...
  'it': {
    ...
    metaDescription: '使用我们的免费人工智能工具生成科技 IT 企业名称。创建传达创新和专业知识的专业名称！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
...
5. Ensure appropriate for B2B technology services`,
  ...
  'jewelry-store': {
    ...
    metaDescription: '用闪闪发光的名称在珠宝业务中闪耀。我们的人工智能工具无需价格就能打造独特的名称！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
    inputLabel: '描述您的珠宝企业...',
...
5. Ensure appropriate for luxury retail positioning`,
  ...
  'lip-gloss': {
    ...
    metaDescription: '用闪闪发光的名称为您的唇彩企业增光。我们的人工智能生成器免费激发创意！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
    inputLabel: '描述您的唇彩企业...',
...
5. Ensure appropriate for beauty/cosmetics market`,
  ...
  'marketing': {
    ...
    metaDescription: '用我们的人工智能生成的名称有效地推销您的业务。快速、免费，旨在取得成功！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
    inputLabel: '描述您的营销业务...',
...
5. Ensure appropriate for B2B professional services`,
  ...
  'music': {
    ...
    metaDescription: '使用我们免费的人工智能生成器用完美的名称创作您的音乐业务成功。立即尝试！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
    inputLabel: '描述您的音乐业务...',
...
5. Ensure appropriate for music industry context`,
  ...
  'perfume': {
    ...
    metaDescription: '用我们免费的人工智能生成器提升您的香水企业名称品牌。快速、免费和创意！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
    inputLabel: '描述您的香水业务...',
...
5. Ensure appropriate for luxury fragrance positioning`,
  ...
  'photography': {
    ...
    metaDescription: '寻找摄影企业的吸引人名称？让人工智能为您完成工作，无需成本！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
    inputLabel: '描述您的摄影业务...',
...
5. Ensure appropriate for professional photography services`,
  ...
  'print-shop': {
    ...
    metaDescription: '用杰出的印刷店名称打印您的成功故事。我们的人工智能工具制作独特的名称，无需价格标签！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
...
5. Ensure appropriate for B2B and B2C print services`,
  ...
  'real-estate': {
    ...
    metaDescription: '轻松找到完美的房地产企业名称。我们的AI工具无需付费，无需复杂流程，只需创意为您的房产事业添彩！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
...
5. Ensure appropriate for professional real estate context`,
  ...
  'shoes': {
    ...
    metaDescription: '用我们免费的AI生成器为您的鞋业企业起个出众名字。快速、免费、富有创意！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
    inputLabel: '描述您的鞋业企业...',
...
5. Ensure appropriate for footwear retail context`,
  ...
  'skin-care': {
    ...
    metaDescription: '用我们免费的AI生成器为您的护肤企业起个完美名字。快速、免费、富有创意！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
    inputLabel: '描述您的护肤企业...',
...
5. Ensure appropriate for skincare and beauty context`,
  ...
  'slime': {
    ...
    metaDescription: '用我们免费的AI生成器为您的史莱姆企业起个趣味名字。快速、免费、富有创意！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
...
5. Ensure appropriate for family-friendly slime business`,
  ...
  'soap': {
    ...
    metaDescription: '用我们免费的AI生成器为您的肥皂企业起个闪闪发光的名字。快速、免费、富有创意！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
    inputLabel: '描述您的肥皂企业...',
...
5. Ensure appropriate for bath and beauty context`,
  ...
  'sportswear': {
    ...
    metaDescription: '用AI生成的名称提升您的运动服装品牌。快速、免费，为您的运动服装企业提供创意十足的命名！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
...
5. Ensure appropriate for athletic apparel context`,
  ...
  't-shirt': {
    ...
    metaDescription: '使用我们的AI工具轻松创建酷的T恤企业名称。无成本、无烦恼，只有对您的服装品牌的创意！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
    inputLabel: '描述您的T恤企业...',
...
5. Ensure appropriate for apparel business context`,
  ...
  'tea': {
    ...
    metaDescription: '使用我们的免费AI生成器为您的茶企打造完美名称。为您的茶业企业创建富有吸引力、令人向往的品牌名称！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
    inputLabel: '描述您的茶企...',
...
5. Ensure appropriate for tea business context`,
  ...
  'tech': {
    ...
    metaDescription: '使用AI生成的名称创新您的科技企业。快速、免费，为您的科技创业项目量身定制！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
    inputLabel: '描述您的科技企业...',
...
5. Ensure appropriate for technology business context`,
  ...
  'travel': {
    ...
    metaDescription: '使用我们的免费AI生成器探索完美的旅行企业名称。为您的旅行创业项目创建冒险、鼓舞的品牌名称！ 立即在Analyze AI上免费试用此工具及更多免费工具。',
    inputLabel: '描述您的旅行企业...',
...
export function getBusinessNameGeneratorZh(slug: string): BusinessNameGeneratorConfig | undefined {
  return Object.values(businessNameGeneratorsZh).find((tool) => tool.slug === slug);
}
