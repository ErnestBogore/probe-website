...
const items = [
  {
    number: "1",
    title: "Discover",
    description: "See where you appear (and where you're missing) in Gemini's answers, which competitors get pulled in alongside you, and which sources Gemini is relying on.",
  ...
  },
  {
    ...
    description: "Track visibility, share of recommendations, traffic from Gemini, landing pages that Gemini is sending users to, and conversion impact over time.",
  ...
  },
  {
    number: "3",
    title: "Improve", 
    description: "Get the exact prompts you're losing in Gemini, why you're losing them, and what content, proof points, or messaging you need to close that gap.",
  ...
  },
  {
    number: "4",
    title: "Govern",
    description: "Catch inaccurate claims, risky language, or negative positioning coming from Gemini before it turns into a sales objection, PR issue, or pipeline problem.",
    image: "/Govern 1x.png",
    href: "/features/govern",
  },
];

export const ModernFeaturesGemini = () => {
  return (
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mt-10 lg:mt-24">
          <h2 className="text-3xl tracking-tight md:text-4xl lg:text-5xl text-gray-900">
            How Analyze AI makes Gemini actionable
          </h2>
          <p className="mt-6 text-lg text-gray-600">
            Analyze AI maps how Gemini talks about you, shows when it prefers a competitor, and ties that to traffic and conversions — so you know where to defend, where to improve, and where to invest.
          </p>
        </div>
