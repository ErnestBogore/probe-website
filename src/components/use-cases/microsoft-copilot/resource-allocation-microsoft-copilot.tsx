...
const bottomItems = [
  {
    ...
    description:
      "See daily movement in Microsoft Copilot answer rankings across your competitive set. Know when you're holding #1, when you're slipping, and when a rival starts gaining visibility so you can respond before it shows up in pipeline.",
    images: [
      {
...
export const ResourceAllocationMicrosoftCopilot = () => {
  return (
    <section
