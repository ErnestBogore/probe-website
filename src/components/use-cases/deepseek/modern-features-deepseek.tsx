...
const items = [
  {
    number: "1",
    title: "Discover",
    description: "See where you appear (and where you're missing) in Deepseek's answers, which competitors get pulled in alongside you, and which sources Deepseek is relying on.",
  ...
  },
  {
    ...
    description: "Track visibility, share of recommendations, traffic from Deepseek, landing pages that Deepseek is sending users to, and conversion impact over time.",
  ...
  },
  {
    number: "3",
    title: "Improve", 
    description: "Get the exact prompts you're losing in Deepseek, why you're losing them, and what content, proof points, or messaging you need to close that gap.",
  ...
  },
  {
    number: "4",
    title: "Govern",
    description: "Catch inaccurate claims, risky language, or negative positioning coming from Deepseek before it turns into a sales objection, PR issue, or pipeline problem.",
    image: "/Govern 1x.png",
    href: "/features/govern",
  },
];

export const ModernFeaturesDeepseek = () => {
  return (
