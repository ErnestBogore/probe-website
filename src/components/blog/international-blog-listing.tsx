...
export function getLocalizedMetadata(language: SupportedLanguage) {
  ...
  return {
    title: `${localizedContent.title} | Analyze`,
    description: localizedContent.description,
    openGraph: {
      title: `${localizedContent.title} | Analyze`,
      description: localizedContent.description,
