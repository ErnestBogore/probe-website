...
const comparisonData = [
  {
    ...
    analyzeDetails: "Yes",
    competitor: true,
    competitorDetails: "Yes (prompt blocks)"
  },
  {
  ...
  },
  {
    ...
    analyzeDetails: "Yes",
    competitor: true,
    competitorDetails: "Limited (prompt-based trends)"
  },
  {
  ...
  },
  {
    ...
    analyzeDetails: "Yes",
    competitor: true,
    competitorDetails: "Content/SEO-centric suggestions (not AI-traffic-tied)"
  },
  {
  ...
  },
  {
    ...
    analyzeDetails: "Low",
    competitor: "Low",
    competitorDetails: "Low"
  },
  {
    capability: "Pricing",
    analyze: "$99/mo",
    analyzeDetails: "$99/mo",
    competitor: "$95 per 25 prompts (plus $175 plan w/ 5 prompts; bundles scale up)",
    competitorDetails: "$95 per 25 prompts (plus $175 plan w/ 5 prompts; bundles scale up)"
  }
];

export const ComparisonSectionSurfer = () => {
  return (
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="text-center mb-16">
            <h2 className="text-2xl tracking-tight md:text-3xl text-gray-900 mb-8">
              <div>Compare how Analyze AI and Surfer AI Tracker impact</div>
                ...
                <thead>
                  <tr className="bg-gray-50 border-b border-gray-200">
                    ...
                    <th className="text-center py-8 px-8 font-bold text-gray-900 text-xl">
                      <div className="flex items-center justify-center gap-2">
                        <Image src="/surfer logo.png" alt="Surfer AI Tracker" width={24} height={24} />
                        <span>Surfer AI Tracker</span>
                      </div>
                    </th>
                  </tr>
                </thead>
