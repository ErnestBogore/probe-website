...
const comparisonData = [
  ...
  },
  {
    ...
    analyzeDetails: "Yes",
    competitor: true,
    competitorDetails: "Partial (brand presence trends)"
  },
  {
  ...
  },
  {
    ...
    analyzeDetails: "Yes",
    competitor: true,
    competitorDetails: "Roadmap/\"Action Center\" on higher tiers"
  },
  {
  ...
  },
  {
    ...
    competitorDetails: "Low–medium"
  },
  {
    capability: "Pricing",
    analyze: "$99/mo",
    analyzeDetails: "$99/mo",
    competitor: "GEO tiers typically $199+/mo (varies by plan)",
    competitorDetails: "GEO tiers typically $199+/mo (varies by plan)"
  }
];

export const ComparisonSectionWritesonicGeo = () => {
  return (
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="text-center mb-16">
            <h2 className="text-2xl tracking-tight md:text-3xl text-gray-900 mb-8">
              <div>Compare how Analyze AI and Writesonic GEO impact</div>
                ...
                <thead>
                  <tr className="bg-gray-50 border-b border-gray-200">
                    ...
                    <th className="text-center py-8 px-8 font-bold text-gray-900 text-xl">
                      <div className="flex items-center justify-center gap-2">
                        <Image src="/writesonic logo.svg" alt="Writesonic GEO" width={24} height={24} />
                        <span>Writesonic GEO</span>
                      </div>
                    </th>
                  </tr>
                </thead>
