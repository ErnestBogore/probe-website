...
const bottomItems = [
  {
    ...
    description:
      "See daily movement in answer rankings across your competitive set. Know when you're holding #1, slipping, or being replaced—before it shows up in forecasts.",
    images: [
      {
  ...
  },
  {
    ...
    description:
      "We surface high-intent prompts where you're not mentioned but a competitor is. You see the gap, the competitor, and recency—ready to hand to content, PMM, and enablement.",
    images: [
      {
...
export const ResourceAllocationHubspotAiSearchGrader = () => {
  return (
    <section
