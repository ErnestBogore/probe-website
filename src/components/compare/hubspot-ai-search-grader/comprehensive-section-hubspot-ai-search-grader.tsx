...
const items = [
  {
    number: "1",
    title: "Discover",
    description: "Identify every high-intent buying prompt, see who's recommended beside you, and inspect the source URLs behind those answers. Not \"mentions\"—market intelligence you can brief into PMM and content.",
  ...
  },
  {
    number: "2", 
    title: "Monitor",
    description: "Attribute sessions and conversions from AI assistants and AI search. Know which sources drive visits, which pages convert, and how contribution changes over time—so you can report a real channel.",
  ...
  },
  {
    number: "3",
    title: "Improve", 
    description: "Get a ranked list of prompts you're losing, why you're losing (down to cited pages and claims), and the exact content/proof to ship. Track whether you enter and climb in those moments.",
  ...
  },
  {
    number: "4",
    title: "Govern",
    description: "Flag risky or off-message claims, watch sentiment and framing drift, and see when a channel quietly drops you—before it shows up in pipeline or exec reviews.",
    image: "/Govern 1x.png",
    href: "/features/govern",
  },
];

export const ComprehensiveSectionHubspotAiSearchGrader = () => {
  return (
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mt-10 lg:mt-24">
          <h2 className="text-3xl tracking-tight md:text-4xl lg:text-5xl text-gray-900">
            Why Analyze AI is more comprehensive than HubSpot AI Search Grader's visibility tracker
          </h2>
