...
const comparisonData = [
  ...
  },
  {
    ...
    analyzeDetails: "Yes",
    competitor: true,
    competitorDetails: "Limited (high-level suggestions)"
  },
  {
    ...
    analyzeDetails: "Yes",
    competitor: true,
    competitorDetails: "Limited snapshot"
  },
  {
    capability: "Setup effort",
    analyze: "Low",
    analyzeDetails: "Low",
    competitor: "Very low (free grader)",
    competitorDetails: "Very low (free grader)"
  },
  {
    capability: "Pricing",
    analyze: "$99/mo",
    analyzeDetails: "$99/mo",
    competitor: "Free tool",
    competitorDetails: "Free tool"
  }
];

export const ComparisonSectionHubspotAiSearchGrader = () => {
  return (
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="text-center mb-16">
            <h2 className="text-2xl tracking-tight md:text-3xl text-gray-900 mb-8">
              <div>Compare how Analyze AI and HubSpot AI Search Grader impact</div>
                ...
                <thead>
                  <tr className="bg-gray-50 border-b border-gray-200">
                    ...
                    <th className="text-center py-8 px-8 font-bold text-gray-900 text-xl">
                      <div className="flex items-center justify-center gap-2">
                        <Image src="/Hubspot AI Search Logo.png" alt="HubSpot AI Search Grader" width={24} height={24} />
                        <span>HubSpot AI Search Grader</span>
                      </div>
                    </th>
                  </tr>
                </thead>
