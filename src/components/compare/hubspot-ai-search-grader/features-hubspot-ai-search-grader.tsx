...
export const FeaturesHubspotAiSearchGrader = () => {
  return (
    <section className="pt-12 pb-24">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto">
          <h2 className="text-3xl tracking-tight md:text-4xl lg:text-5xl text-gray-900">
            Moreover, customers choose Analyze AI because it's actionnable and allows you to do things that HubSpot AI Search Grader can't
          </h2>
