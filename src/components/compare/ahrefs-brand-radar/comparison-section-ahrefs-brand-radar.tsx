...
const comparisonData = [
  ...
  },
  {
    ...
    analyzeDetails: "Yes",
    competitor: true,
    competitorDetails: "\"Gaps/opportunities\" from prompt clusters (not traffic-tied)"
  },
  {
  ...
  },
  {
    ...
    analyze: "Low (plug GA4, add brand)",
    analyzeDetails: "Low (plug GA4, add brand)",
    competitor: "Very low (\"zero setup\")",
    competitorDetails: "Very low (\"zero setup\")"
  },
  {
    capability: "Pricing",
    analyze: "$99/mo",
    analyzeDetails: "$99/mo",
    competitor: "Core plan + add-ons (e.g., AI Overviews bundle $199/mo); overall pricing not fully public",
    competitorDetails: "Core plan + add-ons (e.g., AI Overviews bundle $199/mo); overall pricing not fully public"
  }
];

export const ComparisonSectionAhrefsBrandRadar = () => {
  return (
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="text-center mb-16">
            <h2 className="text-2xl tracking-tight md:text-3xl text-gray-900 mb-8">
              <div>Compare how Analyze AI and Ahrefs Brand Radar impact</div>
                ...
                <thead>
                  <tr className="bg-gray-50 border-b border-gray-200">
                    ...
                    <th className="text-center py-8 px-8 font-bold text-gray-900 text-xl">
                      <div className="flex items-center justify-center gap-2">
                        <Image src="/ahrefs brand radar logo.svg" alt="Ahrefs Brand Radar" width={24} height={24} />
                        <span>Ahrefs Brand Radar</span>
                      </div>
                    </th>
                  </tr>
                </thead>
