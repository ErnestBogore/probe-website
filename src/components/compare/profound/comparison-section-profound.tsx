...
const comparisonData = [
  {
    ...
    analyzeDetails: "Yes",
    competitor: true,
    competitorDetails: "Yes (enterprise)"
  },
  {
  ...
  },
  {
    ...
    analyzeDetails: "Yes",
    competitor: true,
    competitorDetails: "Yes (visibility/trend analytics)"
  },
  {
  ...
  },
  {
    ...
    analyzeDetails: "Yes",
    competitor: true,
    competitorDetails: "Advanced dashboards; fewer traffic-tied actions"
  },
  {
  ...
  },
  {
    ...
    analyze: "Low",
    analyzeDetails: "Low",
    competitor: "Medium–high (enterprise)",
    competitorDetails: "Medium–high (enterprise)"
  },
  {
    capability: "Pricing",
    analyze: "$99/mo",
    analyzeDetails: "$99/mo",
    competitor: "Enterprise pricing; reports of ~$499+/mo",
    competitorDetails: "Enterprise pricing; reports of ~$499+/mo"
  }
];

export const ComparisonSectionProfound = () => {
  return (
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="text-center mb-16">
            <h2 className="text-2xl tracking-tight md:text-3xl text-gray-900 mb-8">
              <div>Compare how Analyze AI and Profound impact</div>
                ...
                <thead>
                  <tr className="bg-gray-50 border-b border-gray-200">
                    ...
                    <th className="text-center py-8 px-8 font-bold text-gray-900 text-xl">
                      <div className="flex items-center justify-center gap-2">
                        <Image src="/profound logo.svg" alt="Profound" width={24} height={24} />
                        <span>Profound</span>
                      </div>
                    </th>
                  </tr>
