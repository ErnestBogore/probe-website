...
const comparisonData = [
  {
    ...
    analyzeDetails: "Yes",
    competitor: true,
    competitorDetails: "Yes (prompt-based tracking)"
  },
  {
  ...
  },
  {
    ...
    analyzeDetails: "Yes",
    competitor: true,
    competitorDetails: "Limited (by tracked prompts & platforms)"
  },
  {
  ...
  },
  {
    ...
    analyzeDetails: "Yes",
    competitor: false,
    competitorDetails: "No (dashboards/alerts)"
  },
  {
    ...
    analyzeDetails: "Yes",
    competitor: true,
    competitorDetails: "Yes (prompt comparisons)"
  },
  {
    capability: "Platform coverage",
    analyze: true,
    analyzeDetails: "Yes (multi-engine)",
    competitor: true,
    competitorDetails: "Yes (starter covers ~3 engines; adds cost for more)"
  },
  {
  ...
  },
  {
    ...
    competitor: "€89/mo (~$95) Starter; €199 Pro; €499 Enterprise",
    competitorDetails: "€89/mo (~$95) Starter; €199 Pro; €499 Enterprise"
  }
];

export const ComparisonSectionPeecAi = () => {
  return (
                ...
                <thead>
                  <tr className="bg-gray-50 border-b border-gray-200">
                    ...
                    <th className="text-center py-8 px-8 font-bold text-gray-900 text-xl">
                      <div className="flex items-center justify-center gap-2">
                        <Image src="/peec ai logo.png" alt="Peec AI" width={24} height={24} />
                        <span>Peec AI</span>
                      </div>
                    </th>
                  </tr>
