...
const comparisonData = [
  ...
  },
  {
    ...
    analyzeDetails: "Yes",
    competitor: true,
    competitorDetails: "Yes (model-level analytics)"
  },
  {
  ...
  },
  {
    ...
    analyzeDetails: "Yes",
    competitor: true,
    competitorDetails: "Strategic insights; enterprise-heavy dashboards"
  },
  {
  ...
  },
  {
    ...
    analyze: "Low",
    analyzeDetails: "Low",
    competitor: "Medium (enterprise onboarding/credits)",
    competitorDetails: "Medium (enterprise onboarding/credits)"
  },
  {
    capability: "Pricing",
    analyze: "$99/mo",
    analyzeDetails: "$99/mo",
    competitor: "~$295–$499+/mo, enterprise-leaning",
    competitorDetails: "~$295–$499+/mo, enterprise-leaning"
  }
];

export const ComparisonSectionAthenaHQ = () => {
  return (
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="text-center mb-16">
            <h2 className="text-2xl tracking-tight md:text-3xl text-gray-900 mb-8">
              <div>Compare how Analyze AI and AthenaHQ impact</div>
                ...
                <thead>
                  <tr className="bg-gray-50 border-b border-gray-200">
                    ...
                    <th className="text-center py-8 px-8 font-bold text-gray-900 text-xl">
                      <div className="flex items-center justify-center gap-2">
                        <Image src="/athenahq logo.png" alt="AthenaHQ" width={24} height={24} />
                        <span>AthenaHQ</span>
                      </div>
                    </th>
                  </tr>
