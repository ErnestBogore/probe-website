...
export const HeroComparisonAthenaHQ = () => {
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="flex items-center justify-center gap-4 mb-8">
            ...
            <Image src="/athenahq logo.png" alt="AthenaHQ" width={48} height={48} />
          </div>
          
          <h1 className="text-foreground text-3xl tracking-tight md:text-4xl lg:text-5xl">
            Analyze AI vs AthenaHQ: which platform gives you deeper AI visibility?
          </h1>
          <p className="text-muted-foreground text-xl mt-6 md:text-2xl max-w-3xl mx-auto">
            Compare how Analyze AI and AthenaHQ measure your AI visibility — from how often your brand appears in AI responses to how that visibility translates into actual traffic and revenue. See where Analyze AI goes deeper, and how that depth turns AI visibility into competitive advantage.
          </p>
