...
const comparisonData = [
  {
    ...
    analyzeDetails: "Yes",
    competitor: true,
    competitorDetails: "Yes (visibility, sentiment, position tracking)"
  },
  {
    ...
    analyzeDetails: "Yes",
    competitor: false,
    competitorDetails: "No (no native GA4 AI-traffic attribution)"
  },
  {
    ...
    analyzeDetails: "Yes",
    competitor: true,
    competitorDetails: "Partial (visibility trends; not GA4 traffic by engine)"
  },
  {
  ...
  },
  {
    ...
    analyzeDetails: "Yes",
    competitor: true,
    competitorDetails: "\"Insights/reports\"; more dashboard-centric"
  },
  {
    ...
    analyzeDetails: "Yes",
    competitor: true,
    competitorDetails: "Yes"
  },
  {
    capability: "Citation/source tracing",
    analyze: true,
    analyzeDetails: "Yes",
    competitor: true,
    competitorDetails: "Yes (prompts/answers & links)"
  },
  {
    capability: "Setup effort",
    analyze: "Low",
    analyzeDetails: "Low",
    competitor: "Medium (Semrush + App Center setup)",
    competitorDetails: "Medium (Semrush + App Center setup)"
  },
  {
    capability: "Pricing",
    analyze: "$99/mo",
    analyzeDetails: "$99/mo",
    competitor: "Add-on/app pricing; not fully public on site",
    competitorDetails: "Add-on/app pricing; not fully public on site"
  }
];

export const ComparisonSectionSemrushAiToolkit = () => {
  return (
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="text-center mb-16">
            <h2 className="text-2xl tracking-tight md:text-3xl text-gray-900 mb-8">
              <div>Compare how Analyze AI and Semrush AI Toolkit impact</div>
                ...
                <thead>
                  <tr className="bg-gray-50 border-b border-gray-200">
                    ...
                    <th className="text-center py-8 px-8 font-bold text-gray-900 text-xl">
                      <div className="flex items-center justify-center gap-2">
                        <Image src="/semrush ai toolkit logo.png" alt="Semrush AI Toolkit" width={24} height={24} />
                        <span>Semrush AI Toolkit</span>
                      </div>
                    </th>
                  </tr>
                </thead>
