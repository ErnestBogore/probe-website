...
const comparisonData = [
  {
    ...
    analyzeDetails: "Yes",
    competitor: false,
    competitorDetails: "Yes/No (Google web search only)"
  },
  {
  ...
  },
  {
    ...
    analyzeDetails: "Yes",
    competitor: false,
    competitorDetails: "Yes/No (SEO diagnostics only)"
  },
  {
  ...
  },
  {
    ...
    analyze: "Low",
    analyzeDetails: "Low",
    competitor: "Low (verify site)",
    competitorDetails: "Yes/Low (verify site)"
  },
  {
    capability: "Pricing",
    analyze: "$99/mo",
    ...
    competitor: "Free",
    competitorDetails: "Yes/Free"
  }
];

export const ComparisonSectionGsc = () => {
  return (
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="text-center mb-16">
            <h2 className="text-2xl tracking-tight md:text-3xl text-gray-900 mb-8">
              <div>Compare how Analyze AI and Google Search Console impact</div>
                ...
                <thead>
                  <tr className="bg-gray-50 border-b border-gray-200">
                    ...
                    <th className="text-center py-8 px-8 font-bold text-gray-900 text-xl">
                      <div className="flex items-center justify-center gap-2">
                        <Image src="/search-console-icon-2025-1.svg" alt="Google Search Console" width={24} height={24} />
