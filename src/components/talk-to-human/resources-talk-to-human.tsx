...
interface ResourcesTalkToHumanProps {
  posts?: BlogPost[];
}

const ResourcesTalkToHuman = ({ posts }: ResourcesTalkToHumanProps) => {
      ...
      <div className="container mx-auto px-4 lg:px-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-semibold text-gray-900 mb-4 md:text-4xl lg:text-5xl">
            A few resources you might want to read in the meantime
          </h2>
