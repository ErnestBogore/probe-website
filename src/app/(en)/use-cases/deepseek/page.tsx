...
const DeepseekUseCasePage = async () => {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: 'Yes. Analyze AI shows the exact language Deepseek is using to justify the recommendation and the specific URLs and domains it\'s citing as evidence. You get the messaging, claims, and assets that are winning that moment — not just "you lost."'
    },
    {
      id: 'faq-4',
      question: 'Can Analyze AI show if Deepseek is sending us traffic, not just talking about us?',
    ...
    },
    {
      ...
      answer: 'Yes. Analyze AI shows how often you appear, how you\'re positioned, who you\'re compared to, and whether that\'s trending up or down. If Deepseek starts preferring a competitor for a high-intent use case, you\'ll see it before Sales feels it.'
    },
    {
      id: 'faq-6',
      question: 'Will Analyze AI tell me which prompts we should go win first in Deepseek?',
      answer: 'Yes. Analyze AI ranks the highest-value prompts you\'re currently losing in Deepseek — the ones most tied to buying intent — and shows you which to fix first. That gives PMM, content, and demand gen a focused "work on these now" list instead of 200 vague ideas.'
    },
    {
      id: 'faq-7',
      question: 'Does this replace SEO tools?',
      answer: 'No. SEO tools tell you how you rank in traditional web search. Analyze AI tells you how Deepseek talks about you, who Deepseek is recommending, which competitors it positions you against, and whether Deepseek is driving traffic and conversions. This is AI buying-path visibility and attribution, not classic search rank tracking.'
    },
    {
      id: 'faq-8',
    ...
    },
    {
      ...
      answer: 'No. Your tracked prompts, competitor set, traffic data, and insights are private to your workspace. Analyze AI doesn\'t reshare your view of how Deepseek talks about you.'
    },
    {
      id: 'faq-11',
      question: 'Can I use Analyze AI for more than Deepseek?',
