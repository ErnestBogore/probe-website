...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: '/compare/analyze-vs-ahrefs-brand-radar',
  },
  openGraph: {
    type: 'website',
    url: '/compare/analyze-vs-ahrefs-brand-radar',
    images: [{
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(generateBreadcrumbSchema([
            { name: 'Home', href: '/' },
            { name: 'Compare', href: '/compare/analyze-vs-ahrefs-brand-radar' },
            { name: 'Analyze vs Ahrefs Brand Radar', href: '/compare/analyze-vs-ahrefs-brand-radar' },
          ]))
        }}
      />
