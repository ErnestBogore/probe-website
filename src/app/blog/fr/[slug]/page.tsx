...
export async function generateMetadata({ params }: BlogPostPageProps) {
  ...
  try {
    ...
    if (!blogPostInternational) {
      return {
        title: 'Article non trouvé | Analyze',
    ...
    const description = blogPostInternational.seo?.description || blogPostInternational.excerpt || 'Lisez cet article perspicace d\'Analyze.';
    ...
    return {
      title: 'Article | Analyze',
      description: 'Lisez cet article perspicace d\'Analyze.',
    };
  }
}
