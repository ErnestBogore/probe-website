...
import { getAllSeoToolsFr } from '@/lib/seo-tools/i18n/seo-tools-config.fr';
...
function SeoToolsSection() {
  const seoTools = getAllSeoToolsFr();
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-gray-600">
            Analysez les mots-clés, vérifiez les classements, surveillez les backlinks et optimisez vos performances dans les moteurs de recherche avec des outils SEO basés sur les données.
          </p>
        </div>
