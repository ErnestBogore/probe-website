...
import { getAllSeoToolsKo } from '@/lib/seo-tools/i18n/seo-tools-config.ko';
...
function SeoToolsSection() {
  const seoTools = getAllSeoToolsKo();
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-gray-600">
            키워드를 분석하고, 순위를 확인하고, 백링크를 모니터링하고, 데이터 기반 SEO 도구로 검색 엔진 성과를 최적화하세요.
          </p>
        </div>
...
export default function FreeToolsKoPage() {
  ...
  const businessNameGenerators = getAllBusinessNameGeneratorsKo();
