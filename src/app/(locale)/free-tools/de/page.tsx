...
import { getAllSeoToolsDe } from '@/lib/seo-tools/i18n/seo-tools-config.de';
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Kostenlose KI-Schreibwerkzeuge',
      },
    ],
  },
  twitter: {
...
function SeoToolsSection() {
  const seoTools = getAllSeoToolsDe();
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-gray-600">
            Analysieren Sie Keywords, prüfen Sie Rankings, überwachen Sie Backlinks und optimieren Sie Ihre Suchmaschinenleistung mit datengestützten SEO-Tools.
          </p>
        </div>
...
export default function FreeToolsDePage() {
  const allTools = getAllToolsDe();
  ...
  return (
    <main className="bg-gray-100">
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-full border border-gray-200 shadow-sm mb-6">
              <span className="text-sm font-medium text-gray-700">Kostenlose KI-Werkzeuge</span>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
              Kostenlose KI-Schreibwerkzeuge
            </h1>
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              <Button asChild>
                <a href="#schreibwerkzeuge" className="bg-gray-900 text-white hover:bg-gray-800">
                  Werkzeuge Erkunden
                </a>
              </Button>
            </div>
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 mt-6">
              <span className="text-sm text-gray-500">Andere Sprachen:</span>
      ...
      {writing.length > 0 && (
        <section id="schreibwerkzeuge" className="py-16 lg:py-20">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="relative flex items-center justify-center mb-10">
              <DashedLine className="text-muted-foreground" />
              <span className="bg-gray-100 text-muted-foreground absolute px-4 font-mono text-sm font-medium tracking-wide max-md:hidden">
            ...
            <div className="text-center max-w-3xl mx-auto mb-12">
              ...
              <p className="text-gray-600">
                Generieren, umformulieren und verbessern Sie Ihre Inhalte mit KI-gestützten Schreibassistenten.
              </p>
            </div>
      ...
      {seo.length > 0 && (
        <section className="py-16 lg:py-20">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center max-w-3xl mx-auto mb-12">
              <h2 className="text-3xl tracking-tight md:text-4xl text-gray-900 mb-4">
                SEO & Content-Marketing Werkzeuge
              </h2>
              <p className="text-gray-600">
                Optimieren Sie Ihre Inhalte für Suchmaschinen und erstellen Sie wirkungsvolle Marketingtexte.
              </p>
            </div>
        ...
        <section className="py-16 lg:py-20">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center max-w-3xl mx-auto mb-12">
              ...
              <p className="text-gray-600">
                Prüfen Sie Grammatik, erkennen Sie KI-Inhalte, humanisieren Sie Ihre Texte und mehr.
              </p>
            </div>
      ...
      {business.length > 0 && (
        <section className="py-16 lg:py-20">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center max-w-3xl mx-auto mb-12">
              <h2 className="text-3xl tracking-tight md:text-4xl text-gray-900 mb-4">
                Business & Marketing Werkzeuge
              </h2>
              <p className="text-gray-600">
                Generieren Sie Markennamen, Slogans, Produktbeschreibungen und Marketingtexte.
              </p>
            </div>
        ...
        <section className="py-16 lg:py-20">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center max-w-3xl mx-auto mb-12">
              ...
              <p className="text-gray-600">
                Erstellen Sie ansprechende Bios, Bildunterschriften, Hashtags und Beiträge für alle Plattformen.
              </p>
            </div>
        ...
        <section className="py-16 lg:py-20">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center max-w-3xl mx-auto mb-12">
              ...
              <p className="text-gray-600">
                Generieren Sie Titel, Beschreibungen und Skripte für Ihre YouTube-Videos.
              </p>
            </div>
        ...
        <section className="py-16 lg:py-20">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="relative flex items-center justify-center mb-10">
              <DashedLine className="text-muted-foreground" />
              <span className="bg-gray-100 text-muted-foreground absolute px-4 font-mono text-sm font-medium tracking-wide max-md:hidden">
                GESCHÄFTSNAMEN-IDEEN
              </span>
            </div>

            <div className="text-center max-w-3xl mx-auto mb-12">
              <h2 className="text-3xl tracking-tight md:text-4xl text-gray-900 mb-4">
                Geschäftsnamen-Ideen Generator
              </h2>
              <p className="text-gray-600">
                Generieren Sie kreative und einprägsame Geschäftsnamen für jede Branche.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              {businessNameGenerators.map((generator) => (
                <Link
                  key={generator.slug}
                  href={`/free-tools/de/business-name-generator/${generator.slug}`}
                  className="group flex gap-4 p-6 bg-white rounded-xl border border-gray-200 hover:border-purple-300 hover:shadow-lg transition-all duration-200"
                >
                  <div className="flex-shrink-0 w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center group-hover:bg-purple-200 transition-colors">
