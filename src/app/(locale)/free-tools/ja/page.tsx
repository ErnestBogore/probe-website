...
import { getAllSeoToolsJa } from '@/lib/seo-tools/i18n/seo-tools-config.ja';
...
function SeoToolsSection() {
  const seoTools = getAllSeoToolsJa();
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-gray-600">
            キーワードを分析し、ランキングを確認し、バックリンクを監視し、データドリブンなSEOツールで検索エンジンのパフォーマンスを最適化しましょう。
          </p>
        </div>
...
export default function FreeToolsJaPage() {
  const allTools = getAllToolsJa();
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-full border border-gray-200 shadow-sm mb-6">
              <span className="text-sm font-medium text-gray-700">無料AIツール</span>
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 mt-6">
              <span className="text-sm text-gray-500">他の言語:</span>
        ...
        <section className="py-16 lg:py-20">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center max-w-3xl mx-auto mb-12">
              ...
              <p className="text-gray-600">
                検索エンジン向けにコンテンツを最適化し、効果的なマーケティングコピーを作成します。
              </p>
            </div>
        ...
        <section className="py-16 lg:py-20">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center max-w-3xl mx-auto mb-12">
              ...
              <p className="text-gray-600">
                文法チェック、AIコンテンツ検出、テキストの人間化などを行います。
              </p>
            </div>
        ...
        <section className="py-16 lg:py-20">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center max-w-3xl mx-auto mb-12">
              ...
              <p className="text-gray-600">
                ブランド名、スローガン、商品説明、マーケティングコピーを生成します。
              </p>
            </div>
        ...
        <section className="py-16 lg:py-20">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center max-w-3xl mx-auto mb-12">
              ...
              <p className="text-gray-600">
                魅力的なプロフィール、キャプション、ハッシュタグ、投稿を作成します。
              </p>
            </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              {businessNameGenerators.map((generator) => (
                <Link
                  key={generator.slug}
                  href={`/free-tools/ja/business-name-generator/${generator.slug}`}
                  className="group flex gap-4 p-6 bg-white rounded-xl border border-gray-200 hover:border-purple-300 hover:shadow-lg transition-all duration-200"
                >
                  <div className="flex-shrink-0 w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center group-hover:bg-purple-200 transition-colors">
