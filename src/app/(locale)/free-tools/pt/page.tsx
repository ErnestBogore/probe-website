...
import { getAllSeoToolsPt } from '@/lib/seo-tools/i18n/seo-tools-config.pt';
...
export const metadata: Metadata = {
  title: 'Ferramentas de Escrita com IA Grátis',
...
function SeoToolsSection() {
  const seoTools = getAllSeoToolsPt();
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-gray-600">
            Analise palavras-chave, verifique rankings, monitore backlinks e otimize seu desempenho nos mecanismos de busca com ferramentas SEO baseadas em dados.
          </p>
        </div>
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 mt-6">
              <span className="text-sm text-gray-500">Outros idiomas:</span>
